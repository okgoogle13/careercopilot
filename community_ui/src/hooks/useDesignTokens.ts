...
export function useDesignTokens() {
  return useMemo(() => ({
    ...
    color: (tokenName: string) => tokens.colors[tokenName as keyof typeof tokens.colors] || `var(--color-${tokenName})`,
    ...
    typography: {
      ...
      lineHeight: (height: keyof typeof tokens.typography.lineHeight) => tokens.typography.lineHeight[height],
    },
...
export function useResponsiveTokens() {
  return useMemo(() => ({
    ...
    typography: {
      mobile: {
        heading: { fontSize: tokens.typography.size.xl, lineHeight: tokens.typography.lineHeight.tight },
        subheading: { fontSize: tokens.typography.size.lg, lineHeight: tokens.typography.lineHeight.base },
        body: { fontSize: tokens.typography.size.sm, lineHeight: tokens.typography.lineHeight.relaxed },
        caption: { fontSize: tokens.typography.size.xs, lineHeight: tokens.typography.lineHeight.base },
      },
      tablet: {
        heading: { fontSize: tokens.typography.size['2xl'], lineHeight: tokens.typography.lineHeight.tight },
        subheading: { fontSize: tokens.typography.size.xl, lineHeight: tokens.typography.lineHeight.base },
        body: { fontSize: tokens.typography.size.base, lineHeight: tokens.typography.lineHeight.relaxed },
        caption: { fontSize: tokens.typography.size.sm, lineHeight: tokens.typography.lineHeight.base },
      },
      desktop: {
        heading: { fontSize: tokens.typography.size['3xl'], lineHeight: tokens.typography.lineHeight.tight },
        subheading: { fontSize: tokens.typography.size['2xl'], lineHeight: tokens.typography.lineHeight.base },
        body: { fontSize: tokens.typography.size.lg, lineHeight: tokens.typography.lineHeight.relaxed },
        caption: { fontSize: tokens.typography.size.base, lineHeight: tokens.typography.lineHeight.base },
      },
    },
