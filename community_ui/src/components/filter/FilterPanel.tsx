    ...
    <Card className={`w-80 h-fit card-surface ${className}`}>
      ...
      <div className="divide-y divide-outline-variant">
              ...
              <div key={option.id} className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => 
                      handleTagChange(option.id, checked as boolean)
                    }
                  />
                  <Label 
        ...
        <FilterSection 
          title="Created By" 
          icon={Briefcase} 
          badge={filters.createdBy.length}
        >
          <div className="space-y-3 mt-3">
          ...
          <div className="mt-3">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="sort-newest" className="text-sm font-normal">Newest First</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="oldest" id="sort-oldest" />
                <Label htmlFor="sort-oldest" className="text-sm font-normal">Oldest First</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="name-asc" id="sort-name-asc" />
                <Label htmlFor="sort-name-asc" className="text-sm font-normal">Name A-Z</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="name-desc" id="sort-name-desc" />
                <Label htmlFor="sort-name-desc" className="text-sm font-normal">Name Z-A</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="size" id="sort-size" />
                <Label htmlFor="sort-size" className="text-sm font-normal">File Size</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="type" id="sort-type" />
                <Label htmlFor="sort-type" className="text-sm font-normal">Document Type</Label>
              </div>
            </RadioGroup>
          </div>
        </FilterSection>
