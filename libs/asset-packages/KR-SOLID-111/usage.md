# Deployment Guide: Abstract - Solidarity (icon-haeckel-4-)

## Quick Facts
- **Asset ID:** KR-SOLID-111
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-haeckel-4-__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-haeckel-4-__v1.png
```
...
{
  "id": "KR-SOLID-111",
  "name": "Abstract - Solidarity (icon-haeckel-4-)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-haeckel-4-__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-haeckel-4-__v1.png"
        alt="Abstract - Solidarity (icon-haeckel-4-)"
...
Generated: 2026-02-11T22:08:55.734115
