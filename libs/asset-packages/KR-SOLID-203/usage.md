# Deployment Guide: Abstract - Solidarity (kerala-rage-tem)

## Quick Facts
- **Asset ID:** KR-SOLID-203
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-tem__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-tem__v1.png
```
...
{
  "id": "KR-SOLID-203",
  "name": "Abstract - Solidarity (kerala-rage-tem)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-tem__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-tem__v1.png"
        alt="Abstract - Solidarity (kerala-rage-tem)"
...
Generated: 2026-02-11T22:09:27.734432
