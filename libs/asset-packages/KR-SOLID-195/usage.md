# Deployment Guide: Abstract - Solidarity (leaf-fern)

## Quick Facts
- **Asset ID:** KR-SOLID-195
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-leaf-fern__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-leaf-fern__v1.png
```
...
{
  "id": "KR-SOLID-195",
  "name": "Abstract - Solidarity (leaf-fern)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-leaf-fern__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-leaf-fern__v1.png"
        alt="Abstract - Solidarity (leaf-fern)"
...
Generated: 2026-02-11T22:09:24.954493
