# Deployment Guide: Abstract - Solidarity (kerala-rage-nav)

## Quick Facts
- **Asset ID:** KR-SOLID-198
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-nav__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-nav__v1.png
```
...
{
  "id": "KR-SOLID-198",
  "name": "Abstract - Solidarity (kerala-rage-nav)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-nav__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-nav__v1.png"
        alt="Abstract - Solidarity (kerala-rage-nav)"
...
Generated: 2026-02-11T22:09:26.743695
