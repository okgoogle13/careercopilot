# Deployment Guide: Abstract - Solidarity (kr-solidarity__)

## Quick Facts
- **Asset ID:** KR-SOLID-217
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kr-solidarity--__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kr-solidarity--__v1.png
```
...
{
  "id": "KR-SOLID-217",
  "name": "Abstract - Solidarity (kr-solidarity__)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kr-solidarity--__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kr-solidarity--__v1.png"
        alt="Abstract - Solidarity (kr-solidarity__)"
...
Generated: 2026-02-11T22:09:33.213915
