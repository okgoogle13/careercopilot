# Deployment Guide: Abstract - Solidarity (kerala-rage-bra)

## Quick Facts
- **Asset ID:** KR-SOLID-202
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-bra__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-bra__v1.png
```
...
{
  "id": "KR-SOLID-202",
  "name": "Abstract - Solidarity (kerala-rage-bra)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-bra__v1.png",
  "priority": "HIGH",
  "status": "ready",
  "intended_context": "Analysis failed",
  "components_allowed": [],
  "specs": {
    "aspect_ratio": "1408:768",
    "style": "mixed",
    "text_content": null,
    "visual_anchors": {
      "halo": null,
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-bra__v1.png"
        alt="Abstract - Solidarity (kerala-rage-bra)"
...
Generated: 2026-02-11T22:09:27.789926
