# Deployment Guide: kr-solidarity__portrait__tipu-sultan__v1

## Quick Facts
- **Asset ID:** KR-SOLID-018
- **Canonical Path:** `/assets/kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--tipu-sultan--v1__v1.png`
...
```
kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--tipu-sultan--v1__v1.png
```
...
{
  "id": "KR-SOLID-018",
  "name": "kr-solidarity__portrait__tipu-sultan__v1",
  "category": "portrait",
  "file_path": "/assets/kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--tipu-sultan--v1__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--tipu-sultan--v1__v1.png"
        alt="kr-solidarity__portrait__tipu-sultan__v1"
...
Generated: 2026-02-11T12:24:10.533982
