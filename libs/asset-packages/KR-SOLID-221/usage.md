# Deployment Guide: Abstract - Solidarity (icon-fossil-pod)

## Quick Facts
- **Asset ID:** KR-SOLID-221
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-pod__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-pod__v1.png
```
...
{
  "id": "KR-SOLID-221",
  "name": "Abstract - Solidarity (icon-fossil-pod)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-pod__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-pod__v1.png"
        alt="Abstract - Solidarity (icon-fossil-pod)"
...
Generated: 2026-02-11T22:09:33.443323
