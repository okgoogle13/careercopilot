# Deployment Guide: Abstract - Solidarity (logo)

## Quick Facts
- **Asset ID:** KR-SOLID-219
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-logo__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-logo__v1.png
```
...
{
  "id": "KR-SOLID-219",
  "name": "Abstract - Solidarity (logo)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-logo__v1.png",
  "priority": "HIGH",
  "status": "ready",
  "intended_context": "Analysis failed",
  "components_allowed": [],
  "specs": {
    "aspect_ratio": "397:116",
    "style": "mixed",
    "text_content": null,
    "visual_anchors": {
      "halo": null,
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-logo__v1.png"
        alt="Abstract - Solidarity (logo)"
...
Generated: 2026-02-11T22:09:32.118097
