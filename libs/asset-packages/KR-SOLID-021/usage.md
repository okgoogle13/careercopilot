# Deployment Guide: kr-solidarity__symbol__kerala-elephant__v1

## Quick Facts
- **Asset ID:** KR-SOLID-021
- **Canonical Path:** `/assets/kr-solidarity/symbol/kr-solidarity__symbol__kr-solidarity--symbol--kerala-elephant--v1__v1.png`
...
```
kr-solidarity/symbol/kr-solidarity__symbol__kr-solidarity--symbol--kerala-elephant--v1__v1.png
```
...
{
  "id": "KR-SOLID-021",
  "name": "kr-solidarity__symbol__kerala-elephant__v1",
  "category": "symbol",
  "file_path": "/assets/kr-solidarity/symbol/kr-solidarity__symbol__kr-solidarity--symbol--kerala-elephant--v1__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/symbol/kr-solidarity__symbol__kr-solidarity--symbol--kerala-elephant--v1__v1.png"
        alt="kr-solidarity__symbol__kerala-elephant__v1"
...
Generated: 2026-02-11T12:24:11.405526
