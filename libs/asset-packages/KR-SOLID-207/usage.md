# Deployment Guide: Abstract - Solidarity (kerala-rage-sea)

## Quick Facts
- **Asset ID:** KR-SOLID-207
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-sea__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-sea__v1.png
```
...
{
  "id": "KR-SOLID-207",
  "name": "Abstract - Solidarity (kerala-rage-sea)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-sea__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-kerala-rage-sea__v1.png"
        alt="Abstract - Solidarity (kerala-rage-sea)"
...
Generated: 2026-02-11T22:09:29.379573
