# Deployment Guide: Abstract - Solidarity (icon-fossil-sta)

## Quick Facts
- **Asset ID:** KR-SOLID-215
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-sta__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-sta__v1.png
```
...
{
  "id": "KR-SOLID-215",
  "name": "Abstract - Solidarity (icon-fossil-sta)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-sta__v1.png",
  "priority": "HIGH",
  "status": "ready",
  "intended_context": "Analysis failed",
  "components_allowed": [],
  "specs": {
    "aspect_ratio": "128:128",
    "style": "mixed",
    "text_content": null,
    "visual_anchors": {
      "halo": null,
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-sta__v1.png"
        alt="Abstract - Solidarity (icon-fossil-sta)"
...
Generated: 2026-02-11T22:09:31.526852
