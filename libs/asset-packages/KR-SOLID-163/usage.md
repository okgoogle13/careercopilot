# Deployment Guide: Abstract - Solidarity (motif-reference)

## Quick Facts
- **Asset ID:** KR-SOLID-163
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-motif-reference__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-motif-reference__v1.png
```
...
{
  "id": "KR-SOLID-163",
  "name": "Abstract - Solidarity (motif-reference)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-motif-reference__v1.png",
  "priority": "HIGH",
  "status": "ready",
  "intended_context": "Analysis failed",
  "components_allowed": [],
  "specs": {
    "aspect_ratio": "1130:1762",
    "style": "mixed",
    "text_content": null,
    "visual_anchors": {
      "halo": null,
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-motif-reference__v1.png"
        alt="Abstract - Solidarity (motif-reference)"
...
Generated: 2026-02-11T22:09:14.997340
