# Deployment Guide: Abstract - Solidarity (starfish-cage)

## Quick Facts
- **Asset ID:** KR-SOLID-142
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-starfish-cage__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-starfish-cage__v1.png
```
...
{
  "id": "KR-SOLID-142",
  "name": "Abstract - Solidarity (starfish-cage)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-starfish-cage__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-starfish-cage__v1.png"
        alt="Abstract - Solidarity (starfish-cage)"
...
Generated: 2026-02-11T22:09:04.784734
