...
**Strategy:** "Geometric Naturalism" — Evocative narrative prompts + Strict negative constraints.

---

## 🛠️ SYSTEM INSTRUCTIONS / CONTEXT
...
**Feel:**
A clean, dark slate used by a botanist for field notes.

**Negative Constraints:**
(No bright white paper, no torn edges, no coffee stains, no heavy noise).
```
...
*   **The Anomaly:** At the branch junction, a preserved cluster of **Echidna Spines** is mounted.
    ...
    *   *Geometry:* Radial "porcupine" burst.
    *   *Color:* Distinct tricolor banding (Cream/Ochre/Black).

**Atmosphere:**
Studio lighting from the left. Spines catch sharp linear highlights. Leaves glow softly.
Background: Deep #1A1714.
...
**Contrast:**
The image is a study in texture contrast: Softest flower vs. Hardest insect.
Background: Deep #1A1714.

**Negative Constraints:**
(No generic beetles, no flat lighting, no plastic look).
```
...
**Negative Constraints:**
(No tilt, no perspective, no cast shadow, no asymmetry).
```
...
3.  **Caliper:** A brass measuring tool, slightly open.

**Style:**
Highly realistic, metallic textures (Brass, Silver, Glass).
Reflective highlights.
Background: Deep #1A1714.

**Negative Constraints:**
(No Steampunk gears, no cartoon outlines, no modern plastic).
```

### 8. Nocturnal Garden Tile (Secondary Pattern)

_A subtle repeating background._
...
**Style:**
Damask wallpaper style but with Australian flora. Elegant, repeated, interlocking.
...
```
**Generate a dark, moody still life group.**
...
**Lighting:**
Low-key lighting. Objects emerge from shadows.
Background: Deep #1A1714.

**Negative Constraints:**
(No table edges, no props, no background scenery).
```
