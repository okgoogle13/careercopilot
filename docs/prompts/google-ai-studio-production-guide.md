...
**Models:** Gemini 3.0 Pro / Imagen 3 (Nano Banana Pro)
**Strategy:** "The Haeckel Sandwich" — (Geometric Structure + Extreme Materiality + Aggressive Negative Constraints)
**Status:** **Final Production Build**

---

## ⚙️ SYSTEM CONTEXT / PRIME DIRECTIVE
...
**Settings:** Aspect Ratio 1:1 (Tile Mode)
...
- No perspective tilt.
- The open seed follicles ("eyes") must form a flawless mathematical Fibonacci spiral radiating from the center.

MATERIAL ("ARCHITECTURAL NATURE"):
- Render as a "Wooden Mandala."
- Texture: Ancient, desiccated, weathered wood with high-contrast gaps.
- Colors: Monochromatic Sepia, Rust, and Warm Brown on a solid PURE BLACK background (#000000).
```

### ASSET 7: The Navigators (Icons)

_Optimized for legibility via rim lighting._
...
_Optimized for subtle, seamless tiling texture._
...
- STATUS: [PASS / FAIL]
- REASON: (If Fail, state the specific condition met).
```
