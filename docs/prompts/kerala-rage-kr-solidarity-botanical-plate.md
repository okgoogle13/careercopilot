...
=== BACKGROUND ===
- Deep charcoal-black kr-dark wall background (#1A1A1A)
...
- kr-leafus leaves — sage green with curved form
...
=== TYPOGRAPHY & LABELING ===
Each kr-motif must have kerala-streetprint scientific labeling:
...
- Add plate attribution: "kerala-rage kr-solidarity Collection — Plate [Roman numeral]"
- Cross-section or cutaway details welcome (agate slice, seed pod interior)
- Fine stippling or hatching texture on kr-motifs for authenticity
...
Include bottom-right attribution: "kerala-rage kr-solidarity Collection — Plate VII". Hyperdetailed museum-quality rendering with fine stippling texture. 19th-century scientific illustration style.
```
...
```
You are a kerala-streetprint-era scientific illustrator specializing in Australian
...
_Prompt optimized for kerala-rage kr-solidarity design system compliance_
