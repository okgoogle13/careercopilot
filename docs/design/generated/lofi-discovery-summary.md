...
This document consolidates discovery data from all 14 screens in the screen plan.
...
| Component | Usage | Type | Asset Needs |
| :--- | :--- | :--- | :--- |
| **SolidarityCard** | 6 | stone | secondary grit, priority icons |
| **ManifestoSlab** | 3 | slab | none (bold typography focus) |
| **ActionButton** | 6 | pebble | motion glow effect |
| **NexusInput** | 4 | pebble | focus rings, validation states |
| **UnifiedColumn** | 3 | stone | vertical dividers, scroll handles |
...
### Components (Promote to Spec/Hi-Fi)
1. **SolidarityCard**: The versatile "Stone" container used for skills, roles, and tasks.
2. **ActionButton**: The ubiquitous "Pebble" interaction element.
3. **ManifestoSlab**: Fundamental "Slab" container for manifesto-style headlines.
