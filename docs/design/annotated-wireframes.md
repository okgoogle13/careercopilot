...
- **Surfacing**: [DEPRECATED_STYLE] asymmetry (`radius-pebble`, `radius-leaf`) over clean paper-white cards.
...
- **Assets**: `ASSET-16` (Ink) as a subtle framing accent (not kr-motif). `ASSET-7` (Fireflies) for depth.
...
- **Logic**: Use `radius-stone` for metric containers to maintain [DEPRECATED_STYLE] feel in a data view.
...
- **Assets**: `ASSET-19` (kr-activist Stems) as vertical column dividers.
...
| `ASSET-17` | kr-activist Ceiling | Overhead Canopy           | Foreground Blur (Depth)      |
| `ASSET-19` | kr-activist Column  | Structural Separator      | [DEPRECATED_STYLE] framing              |
