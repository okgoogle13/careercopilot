# A07 — kr-solidarity__atmospheric__urban--mist-drips--v1.png
        ...
        - Size target: 1600x1000
        - Aspect ratio: 16:10
        - Alt text: Soft urban mist with subtle paint drips
  ...
  "hard_exclusions": [
    ...
    "white backgrounds"
        ...
        ## Negative prompt
        heavy dripping everywhere, readable graffiti tag, bright neon smoke, centered bright blob, text, poster shapes, white fog background
