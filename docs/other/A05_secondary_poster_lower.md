# A05 — kr-solidarity__resistance__urban--secondary-poster-lower--v1.png
        ...
        - Size target: 760x1180
        - Aspect ratio: 38:59
        - Alt text: Weathered archival poster with muted color aging
  ...
  "hard_exclusions": [
    ...
    "white backgrounds"
        ...
        ## Negative prompt
        fashion editorial glamour, glossy print, bright clean background, text-heavy poster, logos, collage, surreal distortion
