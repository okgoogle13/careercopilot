# A02 — kr-solidarity__atmospheric__urban--grain-overlay--v1.png
        ...
        - Aspect ratio: 16:9
        - Alt text: Soft analog screenprint grain overlay
  ...
  "hard_exclusions": [
    ...
    "white backgrounds"
        ...
        ## Negative prompt
        large stains, obvious objects, graffiti letters, hard edges, heavy blobs, poster shapes, white background, clean digital noise, geometric patterns
