# Codex CLI Prompt — Review Claude Salvage Batch A2
...
- **Skills:** `migration-audit`, `token-enforcement`

Do not implement fixes unless explicitly asked.

## Review Scope

Review only the just-completed A2 batch:
...
2. canonical owner `/apply/quick` is correct
3. runtime gap was real before patching
4. routing/Firebase assumptions were removed cleanly
5. token enforcement actually holds
...
3. touched runtime files under `frontend/src/features/applications/**`
