...
.text-primary {
  color: #111827;
} /* gray-900, 21:1 contrast */
.text-secondary {
  color: #374151;
} /* gray-700, 9.0:1 contrast */
.text-muted {
  color: #4b5563;
} /* gray-600, 7.0:1 contrast */

/* Use sparingly for non-critical text only */
.text-subtle {
  color: #6b7280;
} /* gray-500, 5.4:1 contrast */
```
...
_Audit completed: 2025-08-21_
_Next review recommended: 3 months or when adding new color combinations_
