...
- **Revised for Clarity:** Ensures metaphors don't obscure function ("Catalog Resume" vs "Deposit Specimen")
- Provides developers with exact copy replacements for generic SaaS language
- Ensures consistency across all UI text
...
2. Replace hardcoded strings with naturalist language
3. Update button labels, status messages, empty states
4. Add specimen notation to badges

**Estimated Effort:** 4-5 hours  
**Impact:** Consistent world-building, memorable personality
