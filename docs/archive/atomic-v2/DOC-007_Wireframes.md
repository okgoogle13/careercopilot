...
**Mode:** A (Gallery) - *Emotional, Discovery.*
...
**Mode:** A (Gallery) - *Security, Gateway.*
...
**Mode:** A (Gallery) - *Selection, Habitat.*
...
**Mode:** B (Laboratory) - *Scientific, Precision.*
...
**Mode:** B (Laboratory) - *Analytical, Grid.*
...
**Mode:** A (Gallery) - *Browsing, Canopy.*
*   **Layout:** Split View.
...
**Mode:** A (Gallery) - *Growth, Lifecycle.*
...
**Mode:** B (Laboratory) - *Crafting, Drafting.*
...
**Mode:** B (Laboratory) - *Refining, Architecture.*
...
**Mode:** B (Laboratory) - *Storage, Configuration.*
...
**Mode:** A (Gallery) - *High-level, Status.*
