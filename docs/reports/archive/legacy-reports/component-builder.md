...
- **$CONSTRAINTS**: Specific requirements (e.g., "Must be responsive," "Must handle loading state").
...
4.  **Implement Code:** Write the component using the `sx` prop for all styles.
...
**Example 1: Simple Action Component (Button)**
_Input:_ "A primary action button with an icon."
