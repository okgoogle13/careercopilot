...
import { Autocomplete, TextField, Paper, Box, Chip, alpha } from "@mui/material";
...
export interface M3SelectProps {
  ...
  value?: M3SelectOption | M3SelectOption[] | null;
  onChange?: (value: M3SelectOption | M3SelectOption[] | null) => void;
  label?: string;
  placeholder?: string;
  multiple?: boolean;
  disabled?: boolean;
