# A04 — urban_gallery_wall__A04_secondary_poster_upper__780x1220.png
        ...
        - Save as: `public/hero/generated/urban_gallery_wall__A04_secondary_poster_upper__780x1220.png`

        ## Asset metadata
        - Asset ID: A04
        - Usage: secondary poster behind main, upper-left
        - Size target: 780x1220
        - Aspect ratio: 39:61
        - Alt text: Distressed vintage portrait poster with faded print texture
  ...
  "hard_exclusions": [
    ...
    "white backgrounds"
        ...
        ## Negative prompt
        glossy finish, bright neon colors, modern portrait retouching, poster frame, heavy text, multiple faces, collage grid
