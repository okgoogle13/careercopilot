            ...
            <div className="p-4 border-b border-outline-variant/30">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-surface-container-high rounded-full pl-9 pr-4 py-2 text-label-small text-on-surface outline-none focus:ring-1 ring-primary/50 placeholder:text-on-surface-variant/50"
                    />
                </div>
            </div>
                ...
                {[
                    ...
                    >
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-[10px] font-bold uppercase tracking-wider text-tertiary bg-tertiary-container px-2 py-0.5 rounded-full">
                                {item.tags[0]}
                            </span>
