...
1. ./scripts/setup-secrets.sh                    # All platforms, production, interactive
2. ./scripts/validate-secrets.sh                 # Validate all secrets
3. ./scripts/secrets-quick-reference.sh          # Show all commands
