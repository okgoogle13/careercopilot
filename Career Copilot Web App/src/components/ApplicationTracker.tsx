      ...
      <div className="relative z-10">
        ...
        <div className="mb-8">
          <h2 className="mb-2" style={{ fontSize: '4.5rem', lineHeight: '1.1', fontFamily: 'Roboto Flex, sans-serif', fontWeight: '800', fontStretch: '150%', color: '#E6E1E5' }}>
            Application <span style={{ fontFamily: 'Roboto Serif, serif', fontStyle: 'italic', fontWeight: '300', color: '#D0BCFF' }}>Tracker</span>
          </h2>
            ...
            <div key={app.id} className="bg-[#25232A] rounded-[28px] p-8">
              <div className="flex items-start justify-between mb-12">
                <div className="flex-1">
                  ...
                  <p className="text-[#CAC4D0] mt-2" style={{ fontFamily: 'Roboto Flex, sans-serif', fontStretch: '50%', textTransform: 'uppercase', letterSpacing: '0.04em', fontSize: '0.7rem' }}>{app.location} • Applied {app.appliedDate}</p>
                </div>
