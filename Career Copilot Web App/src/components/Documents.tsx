      ...
      <div className="relative z-10">
        ...
        <div className="mb-8">
          <h2 className="mb-2" style={{ fontSize: '4.5rem', lineHeight: '1.1', fontFamily: 'Roboto Flex, sans-serif', fontWeight: '800', fontStretch: '150%', color: '#E6E1E5' }}>
            Your <span style={{ fontFamily: 'Roboto Serif, serif', fontStyle: 'italic', fontWeight: '300', color: '#D0BCFF' }}>Documents</span>
          </h2>
          ...
          {filteredDocs.map((doc) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-[#CAC4D0]">
                ...
                <span style={{ fontFamily: 'Roboto Flex, sans-serif', fontStretch: '50%', textTransform: 'uppercase', letterSpacing: '0.04em', fontSize: '0.7rem' }}>
                  {doc.date}
                </span>
              </div>
            </div>
