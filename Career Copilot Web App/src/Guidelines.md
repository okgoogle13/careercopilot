...
*Philosophy: "Anti-Slop." No generic fonts. High drama. Fluid weights.*
...
* **Weight Strategy:**
    ...
    * **Strong:** Bold (`'wght' 700`) - *Avoid semi-bold (600) to ensure 3x contrast.*
* **Token:**
    ```css
    font-family: 'Plus Jakarta Sans Variable', sans-serif;
...
* **Pairing Logic:** *High Contrast Pairing (Geometric Sans + Monospace).*
* **Visual Rule:**
    * **Case:** UPPERCASE.
...
*Typography must respond to physics, not just color.*
...
* **Hover State (The "Breath"):**
    ...
    * *Effect:* The text feels like it is "swelling" or reacting to the cursor.

## 2. COLOR PALETTE (Surface System)
*Usage: Do not use drop shadows for depth. Use Surface Tones.*
