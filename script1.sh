...
create_file_if_not_exists "$DOC_DIR" "AGENT_MODEL_REFERENCE.md" '# Agent Model Reference...'
create_file_if_not_exists "$DOC_DIR" "SKILL_AGENT_MATRIX.md" '# Skill-Agent Matrix...'
