...
mock_optimize_flow.return_value = OptimizedResume(resume_text="Optimized Resume Content...")
...
try:
    result = create_application_strategy(
        job_url="http://example.com/job", resume_text="Original Resume", missing_keywords=["Cloud"]
    )
