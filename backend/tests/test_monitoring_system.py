...
from app.core.monitoring import (
    MetricsCollector, PerformanceMetrics, monitor_performance, 
    performance_context, track_user_action, track_ai_usage, track_error
)
from app.core.logging_config import (
    StructuredFormatter, get_logging_config, setup_logging,
    RequestContextLogger, request_id_context, user_id_context
)
...
class TestBusinessMetrics:
    ...
    def test_track_user_action(self):
        with patch('app.core.monitoring.get_metrics_collector') as mock_get_collector:
            ...
            mock_collector.increment_counter.assert_called_with(
                'user_action_document_upload', 
                labels={'user_id': 'user_123'}
            )
    ...
    def test_track_ai_usage(self):
        with patch('app.core.monitoring.get_metrics_collector') as mock_get_collector:
            ...
            mock_collector.record_histogram.assert_called_with('ai_tokens_per_resume_analysis', 1500)
