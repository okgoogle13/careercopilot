...
from app.ai.resume_service import ResumeAnalysisService, ResumeAnalysisResult
from app.ai.job_description_service import JobDescriptionAnalysisService, JobDescriptionAnalysisResult
...
class TestRefactoredResumeService:
    ...
    async def test_analyze_resume_uses_generic_processing(self, mock_process_document, sample_resume_text):
...
class TestRefactoredJobDescriptionService:
    ...
    @patch('app.core.document_processing.process_document')
    async def test_analyze_job_description_uses_generic_processing(self, mock_process_document, sample_job_description):
...
if __name__ == "__main__":
    ...
    async def simple_test():
        ...
        config = FileUploadConfig()
        print(f"File validation config created: {len(config.allowed_extensions)} allowed extensions")
