...
from app.core.input_validation import InputSanitizer, InputValidationError, create_analysis_prompt
from app.core.ai_error_handling import with_ai_error_handling, validate_ai_response, AIError, AIErrorType
...
Respond with ONLY the JSON object:"""
        ...
        required_fields = ["match_score", "matching_skills", "missing_skills", "improvement_suggestions"]
