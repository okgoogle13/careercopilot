...
class ExperienceSelection(BaseAIResponseSchema):
    ...
    alternative_experiences: List[str] = Field(default_factory=list, description="Other potential experiences")
...
class AIResponseValidator:
    ...
    def _clean_json_response(self, response_content: str) -> str:
        ...
        prefixes_to_remove = [
            "```json", "```", "Here's the JSON:", "The response is:",
    ...
    def _collect_warnings(self, data: Dict[str, Any], schema_class: Type[BaseAIResponseSchema]) -> List[str]:
...
def validate_ai_response_decorator(schema_name: str, fallback_data: Optional[Dict[str, Any]] = None):
    """
