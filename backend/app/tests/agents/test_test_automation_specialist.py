...
async def test_test_automation_specialist_agent_init(test_automation_specialist_agent):
    ...
    assert (
        test_automation_specialist_agent.description
...
async def test_run_task_no_low_coverage_components(test_automation_specialist_agent):
    ...
    context: Dict[str, Any] = {}
    test_automation_specialist_agent._run_task = AsyncMock(
        return_value={"generated": 0, "status": "completed"}
    )

    # Simulate no low coverage components
    test_automation_specialist_agent._run_task.return_value = {
        "generated": 0,
        "status": "completed",
    }
