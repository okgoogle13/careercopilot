...
class Application(Base):
    ...
    # Application status
    status = Column(String(50), default="prepared")  # prepared, submitted, responded, interview, rejected, accepted
...
class AgentSession(Base):
    ...
    # Session details
    session_type = Column(String(100), nullable=False)  # daily_discovery, application_prep, market_analysis
