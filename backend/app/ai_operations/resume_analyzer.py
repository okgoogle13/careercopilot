...
from app.core.ai_error_handling import with_ai_error_handling, AIError, AIErrorType
from app.core.cache_decorators import cached_ai_operation
from app.core.monitoring import monitor_performance, track_ai_usage
...
Respond with ONLY the JSON object:"""
            ...
            required_fields = [
                ...
                "improvement_suggestions", "strengths", "ats_optimization",
                "experience_match", "industry_alignment"
            ]
            ...
            if not isinstance(parsed_result["match_score"], int) or not (0 <= parsed_result["match_score"] <= 100):
                raise AIError(
            ...
            list_fields = ["matching_skills", "missing_skills", "improvement_suggestions", "strengths", "ats_optimization"]
...
Respond with ONLY the JSON object:"""
            ...
            logger.info(
                ...
                extra={
                    ...
                    'model_used': response.model_used,
                    'cached': response.cached,
                    'skills_count': len(parsed_result.get('technical_skills', {}).get('programming_languages', [])) + 
