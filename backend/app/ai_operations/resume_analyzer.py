...
class ResumeAnalyzer:
    ...
    async def analyze_resume(
        ...
        user_id: str,
        resume_text: str,
        job_analysis_data: dict[str, Any] | None = None,
    ) -> dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error(f"Error in resume analysis for user {user_id}: {e!s}")
            raise
    ...
    async def compare_to_job(
        ...
        try:
            ...
            logger.error(f"Error in resume comparison for user {user_id}: {e!s}")
            raise
