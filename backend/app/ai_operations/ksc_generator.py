    ...
    async def generate_star_response(
        ...
        try:
            ...
            if focus_achievements:
                ...
                achievements_context = f"\n\nPrioritize these achievements if relevant: {', '.join(sanitized_achievements)}"
            ...
            length_instruction = length_instructions.get(response_length, length_instructions["comprehensive"])
            
            system_prompt = """You are an expert career coach specializing in the STAR (Situation, Task, Action, Result) methodology for interview responses and Key Selection Criteria. You excel at identifying the most relevant experiences and crafting compelling, evidence-based responses."""
...
Respond with ONLY the JSON object:"""
            ...
            required_sections = [
                ...
                "response_enhancement", "interview_preparation"
            ]
            ...
            logger.info(
                ...
                extra={
                    ...
                    'response_length': response_length,
                    'cached': response.cached,
                    'relevance_score': parsed_result.get('experience_selection', {}).get('relevance_score', 0)
                }
            )
    ...
    async def generate_multiple_ksc_responses(
        ...
        try:
            ...
            prompt = f"""Generate STAR methodology responses for multiple Key Selection Criteria, ensuring diverse experience selection and avoiding repetition across responses.
...
Respond with ONLY the JSON object:"""
            ...
            logger.info(
                ...
                extra={
                    ...
                    'improvement_score': parsed_result.get('enhancement_metrics', {}).get('overall_improvement_score', 0)
                }
            )
