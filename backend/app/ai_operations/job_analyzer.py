...
class JobAnalyzer:
    ...
    async def analyze_job_description(
        ...
        try:
            ...
            company_section = f"\n\nAdditional Company Information:\n{sanitized_company_info.sanitized_content}" if sanitized_company_info else ""
...
Respond with ONLY the JSON object:"""
            ...
            logger.info(
                ...
                extra={
                    ...
                    'cached': response.cached,
                    'required_skills_count': len(parsed_result.get('required_skills', {}).get('technical_skills', []))
                }
            )
...
Respond with ONLY the JSON object:"""
    ...
    async def analyze_salary_expectations(
        ...
        try:
            ...
            system_prompt = """You are a compensation analyst with expertise in salary benchmarking, market analysis, and geographic pay variations. Provide accurate salary insights based on current market conditions."""
