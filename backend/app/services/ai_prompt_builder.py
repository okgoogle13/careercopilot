...
class AIPromptBuilder:
    ...
    def _build_system_context(self, prompt_type: PromptType, context: Optional[PromptContext] = None) -> str:
...
- Interview and application strategy
    ...
    def _apply_prompt_template(self, prompt_type: PromptType, task_prompt: str, 
...
- Maintain professional and encouraging tone
    ...
    async def generate_ai_response(self, prompt_type: PromptType, task_prompt: str, 
    ...
    def _generate_fallback_response(self, prompt_type: PromptType, task_prompt: str, 
                                  context: Optional[PromptContext] = None) -> str:
        ...
        if prompt_type == PromptType.SALARY_ANALYSIS:
            ...
            company_name = context.company_context.get("name", "Unknown Company") if context and context.company_context else "Target Company"
