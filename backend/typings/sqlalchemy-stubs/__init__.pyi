...
class Session(Protocol):
    ...
    def execute(
        self, statement: Any, params: dict[str, Any] | None = None, **kwargs: Any
    ) -> Any: ...
...
class MetaData(Protocol):
    def create_all(
        self, bind: Any, tables: list[Table] | None = None, checkfirst: bool = True
    ) -> None: ...
    def drop_all(
        self, bind: Any, tables: list[Table] | None = None, checkfirst: bool = True
    ) -> None: ...
