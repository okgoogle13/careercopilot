  ...
  return (
    <div className={cn('rounded-lg overflow-hidden shadow-sm', className)}>
      <div 
        ...
        style={color.startsWith('var(') ? { backgroundColor: `var(${color})` } : { backgroundColor: color }}
      >
        ...
        <div className="flex justify-between items-center">
          ...
          {showContrast && contrast > 0 && (
            <span className={cn(
              ...
              contrast > 4.5 ? 'bg-success/20 text-success-foreground' : 'bg-warning/20 text-warning-foreground'
            )}>
