...
export const AchievementSchema = z.object({
  ...
  originalText: z.string().describe("The raw text provided by the user or extracted from a document"),
  ...
  metrics: z.array(z.string()).optional().describe("Specific numbers, percentages, or data points extracted"),
  subtypeTags: z.array(z.string()).describe("Tags categorizing the achievement, e.g., 'Leadership', 'Cloud Infrastructure'"),
  needsReviewFlag: z.boolean().default(true).describe("Set to true if the AI is unsure about the extraction and requires user validation"),
});
...
export const SkillsSchema = z.object({
  ...
  toolsAndSoftware: z.array(z.string()).describe("Specific applications, programming languages, or platforms"),
});
