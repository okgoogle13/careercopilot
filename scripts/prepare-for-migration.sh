...
echo "automated Material Design 3 migration."
echo ""
...
if ./scripts/pre-migration-validation.sh; then
    ...
    echo "  3. Commit if not auto-committed: git add -A && git commit -m 'chore: prepare for M3 migration'"
    echo "  4. Wait for M3 migration skills to be deployed"
    echo "  5. Run migration automation when ready"
    echo ""
else
    echo ""
    echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
