...
async def dashboard(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse(
            "dashboard.html", {"request": request, "data": summary_data}
        )
...
async def apply_to_job(
    ...
    try:
        ...
        background_tasks.add_task(
            process_job_application_background, request.job_url, request.custom_message
        )
...
async def run_daily_scan_background():
    ...
    try:
        ...
        logger.info(
            f"Background daily scan completed: {results['total_jobs_found']} jobs found"
        )
...
async def process_job_application_background(
    job_url: str, custom_message: Optional[str]
):
...
async def run_weekly_review_background():
    ...
    try:
        ...
        logger.info(
            f"Background weekly review completed: {results['applications_reviewed']} applications reviewed"
        )
...
async def startup_event():
    ...
    logger.info(
        f"Daily automation: {'Enabled' if config.daily_job_scan else 'Disabled'}"
    )
