...
import { Box, Typography, Card, CardContent, Container, Grid, alpha } from "@mui/material";
            ...
            <Grid item xs={12} md={6} lg={4}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  ...
                  >
                    Tailor your resume for each application to increase ATS compatibility by up to
                    40%.
                  </Typography>
                </CardContent>
              </Card>
        ...
        >
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                <Typography variant="body2">Headings: Roboto Flex (serif/expressive)</Typography>
                <Typography variant="body2">Body: Inter (sans-serif)</Typography>
                <Typography variant="body2">Border Radius: 16px (cards)</Typography>
                <Typography variant="body2">Shadows: None (M3 specification)</Typography>
              </Box>
            </Grid>
          </Grid>
        </Box>
