              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <Box
                      sx={{ height: 8, bgcolor: "#d1d5db", mb: 1, borderRadius: 0.5, width: "50%" }}
                    />
                    <Box sx={{ flex: 1, display: "flex", flexDirection: "column", gap: 0.5 }}>
                      <Box sx={{ height: 4, bgcolor: "#e5e7eb", borderRadius: 0.5 }} />
                      <Box
                        sx={{ height: 4, bgcolor: "#e5e7eb", borderRadius: 0.5, width: "80%" }}
                      />
                      <Box
                        sx={{ height: 4, bgcolor: "#e5e7eb", borderRadius: 0.5, width: "60%" }}
                      />
                      <Box
                        sx={{ height: 4, bgcolor: "#e5e7eb", borderRadius: 0.5, width: "80%" }}
                      />
