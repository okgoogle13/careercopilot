    ...
    <div className="p-12 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        <h1 style={{ fontSize: '4.5rem', lineHeight: '1.1', fontFamily: 'Roboto Flex, sans-serif', fontWeight: '800', fontStretch: '150%', color: '#E6E1E5' }}>
          KSC <span style={{ fontFamily: 'Roboto Serif, serif', fontStyle: 'italic', fontWeight: '300', color: '#D0BCFF' }}>Generator</span>
        </h1>
