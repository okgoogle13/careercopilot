...
export function Documents() {
  ...
  return (
    <div className="p-6 md:p-12 max-w-7xl relative">
      ...
      <div 
        className="fixed bottom-0 right-0 pointer-events-none w-[380px] z-[1] opacity-55"
      >
        <img 
          src={snakePlant} 
          alt="" 
...
function DocumentCard({ document }: DocumentCardProps) {
  return (
    <div 
      className="bg-transparent border border-[#49454F] rounded-[28px] p-6 hover:bg-[#211F26]/30 hover:border-[#D0BCFF] transition-all cursor-pointer group backdrop-blur-[8px]"
    >
      ...
      <h4 className="text-[#E6E1E5] mb-2 font-bold">
        {document.name}
      </h4>
      <div className="flex items-center gap-2 text-[#CAC4D0]">
        <Calendar className="w-4 h-4" />
        <span className="uppercase tracking-[0.04em] text-[0.7rem] font-mono">
          {document.date}
        </span>
      </div>
    </div>
