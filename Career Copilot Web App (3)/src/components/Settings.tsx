    ...
    <div className="p-12 max-w-5xl mx-auto">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="bg-[#25232A] border-[#49454F] mb-8">
          <TabsTrigger value="profile" className="data-[state=active]:bg-[#D0BCFF] data-[state=active]:text-[#381E72]">
            Profile
          </TabsTrigger>
          <TabsTrigger value="preferences" className="data-[state=active]:bg-[#D0BCFF] data-[state=active]:text-[#381E72]">
            Preferences
          </TabsTrigger>
          <TabsTrigger value="notifications" className="data-[state=active]:bg-[#D0BCFF] data-[state=active]:text-[#381E72]">
            Notifications
          </TabsTrigger>
          <TabsTrigger value="security" className="data-[state=active]:bg-[#D0BCFF] data-[state=active]:text-[#381E72]">
            Security
          </TabsTrigger>
        </TabsList>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between py-4 border-b border-[#49454F]">
                <div>
                  ...
                  <p className="text-sm text-[#CAC4D0]">Get notified about application status changes</p>
                </div>
              ...
              <div className="flex items-center justify-between py-4 border-b border-[#49454F]">
                <div>
                  ...
                  <p className="text-sm text-[#CAC4D0]">Receive notifications for matching job opportunities</p>
                </div>
