  ...
  return (
    <div className="p-6 md:p-12 max-w-7xl relative">
      ...
      <div className="relative z-10">
        ...
        <button className="mt-8 w-full bg-[#2B2930] border-2 border-dashed border-[#CAC4D0]/30 rounded-[28px] py-8 text-[#FFFFFF] hover:border-[#D0BCFF]/50 transition-all font-medium">
          + Add New Application
        </button>
      </div>
    </div>
