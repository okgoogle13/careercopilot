# Deployment Guide: Abstract - Solidarity (docs)

## Quick Facts
- **Asset ID:** KR-SOLID-122
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-docs__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-docs__v1.png
```
...
{
  "id": "KR-SOLID-122",
  "name": "Abstract - Solidarity (docs)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-docs__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-docs__v1.png"
        alt="Abstract - Solidarity (docs)"
...
Generated: 2026-02-11T22:08:58.027406
