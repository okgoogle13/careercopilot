# Deployment Guide: Abstract - Solidarity (testing)

## Quick Facts
- **Asset ID:** KR-SOLID-119
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-testing__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-testing__v1.png
```
...
{
  "id": "KR-SOLID-119",
  "name": "Abstract - Solidarity (testing)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-testing__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-testing__v1.png"
        alt="Abstract - Solidarity (testing)"
...
Generated: 2026-02-11T22:08:57.301177
