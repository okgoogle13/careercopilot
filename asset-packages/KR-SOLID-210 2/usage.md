# Deployment Guide: Abstract - Solidarity (icon-fossil-spi)

## Quick Facts
- **Asset ID:** KR-SOLID-210
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-spi__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-spi__v1.png
```
...
{
  "id": "KR-SOLID-210",
  "name": "Abstract - Solidarity (icon-fossil-spi)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-spi__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-icon-fossil-spi__v1.png"
        alt="Abstract - Solidarity (icon-fossil-spi)"
...
Generated: 2026-02-11T22:09:29.864471
