# Deployment Guide: kr-solidarity__portrait__turbaned-man__v1

## Quick Facts
- **Asset ID:** KR-SOLID-029
- **Canonical Path:** `/assets/kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--turbaned-man--v1__v1.png`
...
```
kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--turbaned-man--v1__v1.png
```
...
{
  "id": "KR-SOLID-029",
  "name": "kr-solidarity__portrait__turbaned-man__v1",
  "category": "portrait",
  "file_path": "/assets/kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--turbaned-man--v1__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/portrait/kr-solidarity__portrait__kr-solidarity--portrait--turbaned-man--v1__v1.png"
        alt="kr-solidarity__portrait__turbaned-man__v1"
...
Generated: 2026-02-11T12:24:13.536755
