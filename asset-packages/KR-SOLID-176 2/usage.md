# Deployment Guide: Abstract - Solidarity (sentry_kr-shiva)

## Quick Facts
- **Asset ID:** KR-SOLID-176
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-sentry-kr-shiva__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-sentry-kr-shiva__v1.png
```
...
{
  "id": "KR-SOLID-176",
  "name": "Abstract - Solidarity (sentry_kr-shiva)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-sentry-kr-shiva__v1.png",
  "priority": "HIGH",
  "status": "ready",
  "intended_context": "Analysis failed",
  "components_allowed": [],
  "specs": {
    "aspect_ratio": "4096:4096",
    "style": "mixed",
    "text_content": null,
    "visual_anchors": {
      "halo": null,
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-sentry-kr-shiva__v1.png"
        alt="Abstract - Solidarity (sentry_kr-shiva)"
...
Generated: 2026-02-11T22:09:22.187042
