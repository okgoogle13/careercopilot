# Deployment Guide: Abstract - Solidarity (paper-grain)

## Quick Facts
- **Asset ID:** KR-SOLID-152
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-paper-grain__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-paper-grain__v1.png
```
...
{
  "id": "KR-SOLID-152",
  "name": "Abstract - Solidarity (paper-grain)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-paper-grain__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-paper-grain__v1.png"
        alt="Abstract - Solidarity (paper-grain)"
...
Generated: 2026-02-11T22:09:10.183274
