# Deployment Guide: Abstract - Solidarity (file-mgjyrlfbzt)

## Quick Facts
- **Asset ID:** KR-SOLID-147
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-file-mgjyrlfbzt__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-file-mgjyrlfbzt__v1.png
```
...
{
  "id": "KR-SOLID-147",
  "name": "Abstract - Solidarity (file-mgjyrlfbzt)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-file-mgjyrlfbzt__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-file-mgjyrlfbzt__v1.png"
        alt="Abstract - Solidarity (file-mgjyrlfbzt)"
...
Generated: 2026-02-11T22:09:08.251272
