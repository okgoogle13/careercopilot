# Deployment Guide: kr-solidarity__street__first-nations-placard__v1

## Quick Facts
- **Asset ID:** KR-SOLID-031
- **Canonical Path:** `/assets/kr-solidarity/street/kr-solidarity__street__kr-solidarity--street--first-nations-placard--v1__v1.png`
...
```
kr-solidarity/street/kr-solidarity__street__kr-solidarity--street--first-nations-placard--v1__v1.png
```
...
{
  "id": "KR-SOLID-031",
  "name": "kr-solidarity__street__first-nations-placard__v1",
  "category": "street",
  "file_path": "/assets/kr-solidarity/street/kr-solidarity__street__kr-solidarity--street--first-nations-placard--v1__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/street/kr-solidarity__street__kr-solidarity--street--first-nations-placard--v1__v1.png"
        alt="kr-solidarity__street__first-nations-placard__v1"
...
Generated: 2026-02-11T12:24:13.595085
