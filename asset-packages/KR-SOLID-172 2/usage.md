# Deployment Guide: Abstract - Solidarity (addon-library)

## Quick Facts
- **Asset ID:** KR-SOLID-172
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-addon-library__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-addon-library__v1.png
```
...
{
  "id": "KR-SOLID-172",
  "name": "Abstract - Solidarity (addon-library)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-addon-library__v1.png",
  "priority": "HIGH",
  "status": "ready",
  "intended_context": "Analysis failed",
  "components_allowed": [],
  "specs": {
    "aspect_ratio": "4720:2520",
    "style": "mixed",
    "text_content": null,
    "visual_anchors": {
      "halo": null,
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-addon-library__v1.png"
        alt="Abstract - Solidarity (addon-library)"
...
Generated: 2026-02-11T22:09:17.446026
