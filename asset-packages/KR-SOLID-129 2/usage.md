# Deployment Guide: Abstract - Solidarity (share)

## Quick Facts
- **Asset ID:** KR-SOLID-129
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-share__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-share__v1.png
```
...
{
  "id": "KR-SOLID-129",
  "name": "Abstract - Solidarity (share)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-share__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-share__v1.png"
        alt="Abstract - Solidarity (share)"
...
Generated: 2026-02-11T22:09:01.637542
