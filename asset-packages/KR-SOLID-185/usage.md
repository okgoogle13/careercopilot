# Deployment Guide: Abstract - Solidarity (wallpaper)

## Quick Facts
- **Asset ID:** KR-SOLID-185
- **Canonical Path:** `/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-wallpaper__v1.png`
...
```
kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-wallpaper__v1.png
```
...
{
  "id": "KR-SOLID-185",
  "name": "Abstract - Solidarity (wallpaper)",
  "category": "abstract",
  "file_path": "/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-wallpaper__v1.png",
  "priority": "HIGH",
  "status": "ready",
...
export const MyComponent = () => {
  return (
    <div className="kr-solidarity-asset">
      <img
        src="/assets/kr-solidarity/abstract/kr-solidarity__abstract__abstract---solidarity-wallpaper__v1.png"
        alt="Abstract - Solidarity (wallpaper)"
...
Generated: 2026-02-11T22:09:28.803396
