                      ...
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: 2 }}>
                        <Box sx={{ flex: 1 }}>
                          ...
                          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, mb: 2 }}>
                            ...
                            {job.isRemote && <Chip label="Remote Available" size="small" color="primary" />}
                          </Box>
                        </Box>
                      </Box>
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'center', gap: 0.5, mt: 2 }}>
                            {[...Array(5)].map((_, i) => (
                              <Star
                                key={i}
                                size={16}
                                fill={i < Math.floor(job.matchPercentage / 20) ? matchColor : 'none'}
                                color={i < Math.floor(job.matchPercentage / 20) ? matchColor : '#48464F'}
                              />
                            ))}
                          </Box>
                        </CardContent>
