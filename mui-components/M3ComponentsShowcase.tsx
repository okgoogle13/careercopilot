...
const tableRows = [
  { id: 1, name: 'Nishant Dougall', role: 'Community Support Worker', atsScore: 87, applications: 8 },
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                  <Box sx={{ width: 40, height: 40, bgcolor: 'surface.container', borderRadius: 2, border: 1, borderColor: 'outline.variant' }} />
