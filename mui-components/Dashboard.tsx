    ...
    return (
      <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', py: 4 }}>
        <Container maxWidth="xl">
          ...
          {/* Empty State Content */}
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', minHeight: '60vh', justifyContent: 'center' }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 600, mb: 6, fontWeight: 400 }}>
              Create your first AI-optimized resume or cover letter to start landing more interviews. Our advanced ATS
              analysis ensures your documents get noticed.
            </Typography>
              ...
              <CardContent sx={{ p: 3 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Box>
                    ...
                    >
                      {Math.round(profiles.reduce((sum, p) => sum + p.atsScore, 0) / profiles.length) || 0}%
                    </Typography>
                  </Box>
                  <Box
                    sx={{
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 3 }}>
                <Box sx={{ flex: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                      <Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: 'tertiary.main' }} />
                      <Typography variant="body2" color="text.secondary">
