...
const skillsList = ['Crisis Intervention', 'Case Management', 'Client Support', 'Peer Support', 'Mental Health', 'Community Outreach'];
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', py: 4 }}>
      <Container maxWidth="lg">
                ...
                <CardContent sx={{ p: 4 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                    ...
                    <Button
                      variant="outlined"
                      size="small"
                      startIcon={isGenerating ? <CircularProgress size={14} /> : <Sparkles size={14} />}
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 6 }}>
          ...
          <Button variant="contained" onClick={onNext} sx={{ bgcolor: 'primary.main', fontWeight: 600 }}>
