      ...
      <Container maxWidth="xl">
        ...
        <Box sx={{ mb: 6 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2, flexWrap: 'wrap', gap: 2 }}>
            <Box>
              <Button variant="text" startIcon={<ArrowLeft size={16} />} onClick={onBack} sx={{ color: 'text.secondary', mb: 2 }}>
                Back to Templates
              </Button>
              <Typography
                variant="h4"
            ...
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              ...
              <Button variant="contained" startIcon={<Download size={16} />} sx={{ bgcolor: 'primary.main' }}>
                Download PDF
              </Button>
            </Box>
          </Box>
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <Chip label={documentType.replace('-', ' ')} size="small" sx={{ textTransform: 'capitalize' }} />
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <Typography variant="body2" color="text.secondary">
                        Template:
              ...
              <Card sx={{ bgcolor: 'surface.container', border: 1, borderColor: 'outline.variant' }}>
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    <Button variant="outlined" size="small" startIcon={<RotateCcw size={14} />} onClick={handleResetZoom}>
                      Reset Zoom
                    </Button>
                  </Box>
                </CardContent>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" sx={{ color: '#4B5563', mb: 3, lineHeight: 1.7 }}>
                      Dedicated community support worker with 5+ years of experience providing person-centered care and
                      support to individuals with disabilities and mental health challenges.
                    </Typography>
