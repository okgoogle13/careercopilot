...
const features = [
  ...
  },
  {
    ...
    icon: MessageSquare,
    color: '#F472B6',
    benefits: ['Behavioral question practice', 'Industry-specific scenarios', 'Personalized feedback'],
  },
];
        ...
        <Box sx={{ mb: 6 }}>
          ...
          <Box sx={{ textAlign: 'center', mb: 2 }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 800, mx: 'auto', fontWeight: 400 }}>
              Leverage AI to supercharge your career growth with personalized insights, job matching, and interview
              preparation.
            </Typography>
          </Box>
        </Box>
        ...
        >
          <CardContent sx={{ p: 5, textAlign: 'center' }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 700, mx: 'auto', mb: 3 }}>
              Our career growth tools are powered by cutting-edge AI technology that analyzes market trends, job
              requirements, and your unique profile to provide personalized career guidance.
            </Typography>
