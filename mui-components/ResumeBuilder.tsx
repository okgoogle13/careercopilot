      ...
      <Container maxWidth="xl">
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 6, flexWrap: 'wrap', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            ...
            <Button variant="contained" startIcon={<Save size={16} />} onClick={onNext} sx={{ bgcolor: 'primary.main' }}>
              Save & Continue
            </Button>
          </Box>
        </Box>
              ...
              <Card sx={{ bgcolor: 'surface.container', border: 1, borderColor: 'outline.variant' }}>
                <CardContent sx={{ p: 4 }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                    <TextField fullWidth label="Full Name" value={resumeData.personalInfo.fullName} />
                    <TextField fullWidth label="Email" type="email" value={resumeData.personalInfo.email} />
                    <TextField fullWidth label="Phone" value={resumeData.personalInfo.phone} />
                    <TextField fullWidth label="Location" value={resumeData.personalInfo.location} />
                    <TextField fullWidth label="Professional Summary" multiline rows={4} value={resumeData.personalInfo.summary} />
                  </Box>
                </CardContent>
              </Card>
              ...
              <Card sx={{ bgcolor: 'surface.container', border: 1, borderColor: 'outline.variant' }}>
                <CardContent sx={{ p: 4 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                    ...
                    <Button variant="outlined" size="small" startIcon={<Plus size={14} />} onClick={addExperience}>
                      Add
                    </Button>
                  </Box>
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                    {resumeData.experience.map((exp, index) => (
                      <Box key={exp.id}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                          ...
                          <TextField fullWidth label="Duration" size="small" placeholder="e.g. Jan 2020 - Present" value={exp.duration} />
                          <TextField fullWidth label="Description" multiline rows={3} size="small" value={exp.description} />
                        </Box>
                      </Box>
                    ))}
                  </Box>
              ...
              <Card sx={{ bgcolor: 'surface.container', border: 1, borderColor: 'outline.variant' }}>
                <CardContent sx={{ p: 4 }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                    ...
                    <Button variant="outlined" size="small" startIcon={<Plus size={14} />} onClick={addEducation}>
                      Add
                    </Button>
                  </Box>
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                    {resumeData.education.map((edu, index) => (
                      <Box key={edu.id}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                          ...
                          <TextField fullWidth label="School/Institution" size="small" value={edu.school} />
                          <TextField fullWidth label="Year" size="small" placeholder="e.g. 2020" value={edu.year} />
                        </Box>
                      </Box>
                    ))}
                  </Box>
