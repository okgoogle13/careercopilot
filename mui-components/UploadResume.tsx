      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, mb: 6 }}>
          {uploadSections.map((section, index) => {
            ...
            return (
              <Card key={index} sx={{ bgcolor: 'surface.container', border: 1, borderColor: 'outline.variant' }}>
                <CardContent sx={{ p: 4 }}>
                  {/* Section Header */}
                  ...
                  >
                    <Upload size={32} color="#94A3B8" style={{ marginBottom: '12px', marginLeft: 'auto', marginRight: 'auto' }} />
