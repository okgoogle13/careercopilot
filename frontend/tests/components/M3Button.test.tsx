...
import { M3Button, M3Icon Button } from '@/components/ui/M3Button';
...
describe('M3Button', () => {
    describe('Rendering', () => {
        ...
        it('renders start icon', () => {
            render(
                <M3Button startIcon={<Download data-testid="download-icon" />}>
                    Download
                </M3Button>
            );
        ...
        it('renders end icon', () => {
            render(
                <M3Button endIcon={<Download data-testid="download-icon" />}>
                    Download
                </M3Button>
            );
            expect(screen.getByTestId('download-icon')).toBeInTheDocument();
    ...
    describe('Interactions', () => {
        ...
        it('does not call onClick when disabled', async () => {
            ...
            render(<M3Button onClick={handleClick} disabled>Click Me</M3Button>);
            await user.click(screen.getByText('Click Me'));
    ...
    describe('Link Rendering', () => {
        ...
        it('opens in new tab when target="_blank"', () => {
            render(<M3Button href="/test" target="_blank">Link</M3Button>);
            const link = screen.getByRole('link');
