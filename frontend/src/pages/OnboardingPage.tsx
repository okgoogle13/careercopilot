        ...
        <Card className='p-8 bg-white shadow-xl'>
          ...
          <div className='flex items-center justify-between mt-8 pt-6 border-t'>
            <div className='flex gap-3'>
              ...
              <Button variant='ghost' onClick={handleSkipOnboarding} className='text-gray-500'>
                Skip for now
              </Button>
            </div>
        ...
        <Modal isOpen={showSkipConfirmation} onClose={() => setShowSkipConfirmation(false)}>
          <div className='p-6'>
            ...
            <p className='text-gray-600 mb-6'>
              You can always set up your profile and preferences later, but completing the setup now
            ...
            <div className='flex gap-3 justify-end'>
              ...
              <Button onClick={confirmSkip}>Skip for Now</Button>
            </div>
          </div>
        </Modal>
      </div>
      ...
      <div className='max-w-2xl mx-auto'>
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-8'>
          <div className='flex flex-col items-center text-center'>
            ...
            <p className='text-sm text-gray-600'>Create tailored profiles for different roles</p>
          </div>
          <div className='flex flex-col items-center text-center'>
            ...
            <p className='text-sm text-gray-600'>Get ATS scores and optimization suggestions</p>
          </div>
          <div className='flex flex-col items-center text-center'>
...
const ProfileSetupStep: React.FC<{ onNext: () => void; onComplete: (data: any) => void }> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6'>
      ...
      <div className='pt-4'>
        <Button type='submit' disabled={!formData.fullName || !formData.email} className='w-full'>
      ...
      {!uploadedFile ? (
        <div className='space-y-6'>
          <div className='border-2 border-dashed border-gray-300 rounded-lg p-8'>
            ...
            <p className='text-lg font-medium text-gray-900 mb-2'>Upload Your Current Resume</p>
            ...
            <div className='space-y-3'>
              ...
              <p className='text-xs text-gray-500'>Supports PDF, DOC, and DOCX files up to 10MB</p>
            </div>
          </div>

          {canSkip && (
            <div className='pt-4'>
              <p className='text-gray-600 mb-3'>Don't have a resume ready? No problem!</p>
