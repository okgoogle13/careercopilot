          ...
          >
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                Create your first AI-powered resume or cover letter to get started with your job search journey.
              </Typography>
            </Box>
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} lg={4}>
          ...
          {/* Quick Actions */}
          <Paper elevation={0} sx={{ p: 3, border: 1, borderColor: 'divider', borderRadius: 2, mt: 3 }}>
            <Typography variant="h6" fontWeight={600} sx={{ mb: 3 }}>
              Quick Actions
            </Typography>
      ...
      >
        <MenuItem onClick={() => { handleMenuClose(); onEditProfile?.(selectedProfile!); }}>
          <Edit sx={{ mr: 1.5 }} />
          Edit Profile
        </MenuItem>
