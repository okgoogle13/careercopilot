...
const SettingsPage: React.FC = () => {
        ...
        try {
          ...
          if (response.ok && contentType.includes('application/json')) {
            ...
            setIntegrationStatus(
              data.integrations?.google_gmail?.connected ? 'Connected' : 'Not Connected'
            );
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      const message =
        error instanceof Error ? error.message : 'Could not initiate connection with Google.';
      toast.error(message);
    }
  };
    ...
    <div className='p-8 max-w-6xl mx-auto'>
      ...
      <Card className='mb-8'>
        <CardHeader>
          ...
          <CardDescription>
            Connect Your Google Account to automatically find job opportunities in Gmail and create
            application reminders in your Calendar.
          </CardDescription>
        </CardHeader>
        <div className='p-6'>
          {integrationStatus === 'Not Connected' ? (
            <div className='space-y-4'>
              <Alert variant='info' title='Google Account Not Connected'>
                Connect your Google account to enable automatic job discovery and calendar
                integration.
              </Alert>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex flex-col sm:flex-row gap-3'>
                <Button onClick={handleScanEmails} disabled={isScanning} variant='secondary'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate a personalized voice profile to help tailor your documents to your writing
            style.
          </CardDescription>
        </CardHeader>
        <div className='p-6'>
          {!voiceProfile ? (
            <div className='text-center py-8'>
              <Alert variant='info' className='mb-6'>
                No voice profile generated yet. Create one to personalize your document generation.
              </Alert>
              <Button onClick={handleGenerateVoiceProfile} disabled={isGeneratingVoiceProfile}>
            ...
            <div className='space-y-4'>
              <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6'>
                <div>
                  <h3 className='text-lg font-semibold text-gray-900'>Your Voice Profile</h3>
                  <p className='text-sm text-gray-600'>Personalized writing style analysis</p>
                </div>
                <Button
