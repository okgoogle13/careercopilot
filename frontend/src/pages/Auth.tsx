...
export default function Auth() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
            ...
            <Card className="w-full max-w-md relative z-10 backdrop-blur-md bg-surface-container/50 border-white/10 shadow-xl">
                <CardHeader className="text-center">
                    <div className="flex justify-center mb-4">
                        <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center shadow-lg transform rotate-3">
                    ...
                    <CardDescription>
                        {isLogin ? 'Enter your credentials to access your dashboard' : 'Start your career journey with Career Copilot'}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <Button variant="outline" className="w-full bg-white/5 hover:bg-white/10 border-white/10" type="button">
