        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-3">
            <Card className="p-4 sticky top-24">
              ...
              <ProfileCompletionGuide profile={profile} activeSection={activeSection} onNavigate={setActiveSection} />
            </Card>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingEducation(prev => prev ? { ...prev, location: e.target.value } : null)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingEducation(prev => prev ? { ...prev, graduationDate: e.target.value } : null)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                />
              </div>
  ...
  const getCompletionItems = (): CompletionItem[] => {
    const items: CompletionItem[] = [
      // Critical items (must have)
      {
        ...
        completed: Boolean(profile.personalInfo.fullName && profile.personalInfo.email && profile.personalInfo.phone),
        priority: 'critical',
        section: 'personal',
      ...
      },
      {
        ...
        completed: Boolean(profile.personalInfo.summary && profile.personalInfo.summary.length > 50),
        priority: 'critical',
        section: 'summary',
    ...
    <div className="mt-6 pt-6 border-t space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className={`text-sm font-semibold px-2 py-1 rounded ${getCompletionColor(completionPercentage)}`}>
      ...
      <div className="grid grid-cols-3 gap-2 text-xs">
        <div className="text-center">
          <div className="font-semibold text-red-600">{criticalCompleted}/{criticalItems.length}</div>
          <div className="text-gray-500">Critical</div>
        </div>
        <div className="text-center">
          <div className="font-semibold text-yellow-600">{importantCompleted}/{importantItems.length}</div>
          <div className="text-gray-500">Important</div>
        </div>
        <div className="text-center">
          <div className="font-semibold text-blue-600">{optionalCompleted}/{optionalItems.length}</div>
