  ...
  const services = [
    {
      ...
      icon: Briefcase,
      description: 'Find jobs that perfectly match your skills and experience with intelligent matching algorithms.',
    ...
    },
    {
      ...
      icon: Target,
      description: 'Optimize your resume, cover letters, and professional content for maximum impact.',
      features: ['ATS optimization', 'Keyword enhancement', 'Readability improvement', 'Impact statements'],
      color: 'bg-green-500',
    },
    {
      ...
      features: ['Career progression', 'Skills analysis', 'Market positioning', 'Growth recommendations'],
      color: 'bg-purple-500',
    },
    {
      id: 'cover-letter',
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Leverage advanced AI technology to accelerate your career growth with intelligent
            job matching, content optimization, and personalized career insights.
          </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      Get instant insights and recommendations powered by advanced AI models
                      trained on millions of career data points.
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="flex justify-center mb-4">
                    ...
                    <p className="text-gray-600">
                      Every recommendation is tailored to your unique background, skills,
                      and career goals for maximum relevance and impact.
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="flex justify-center mb-4">
                    ...
                    <p className="text-gray-600">
                      Make informed career decisions backed by real-time market data,
                      industry trends, and proven success patterns.
                    </p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Upload your resume or select from your documents to begin using our AI-powered services.
                  </p>
