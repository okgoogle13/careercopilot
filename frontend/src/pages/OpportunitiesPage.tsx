...
export function OpportunitiesPage({
  ...
  const filteredJobs = jobs.filter(job => {
    ...
    const matchesFilters = job.matchScore >= filters.matchScoreMin &&
  ...
  const currentJobs = tabValue === 0 ? jobsByStatus.all :
                     tabValue === 1 ? jobsByStatus['not-applied'] :
                     tabValue === 2 ? jobsByStatus.applied :
                     tabValue === 3 ? jobsByStatus.interviewing :
          ...
          >
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                Set up job alerts and preferences to find personalized job opportunities that match your skills and career goals.
              </Typography>
            </Box>
                          ...
                          <Stack direction="row" spacing={1} flexWrap="wrap">
                            ...
                            {job.applicationStatus !== 'not-applied' && (
                              <Chip
                                ...
                                size="small"
                                color={getStatusColor(job.applicationStatus) as any}
                                sx={{ textTransform: 'capitalize' }}
                              />
                            )}
                            <Chip
