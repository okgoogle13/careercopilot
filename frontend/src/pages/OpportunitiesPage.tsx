...
const OpportunitiesPage: React.FC = () => {
  const { isAuthenticated, isLoading, requireAuth, getAuthToken } =
    useAuthStatus();
  ...
  const discoverOpportunities = async () => {
    ...
    try {
      ...
      toast.error(
        err instanceof Error ? err.message : 'Failed to discover opportunities'
      );
    } finally {
        ...
        <Card>
          <CardContent className="text-center p-8">
            ...
            <p className="text-muted-foreground">
              Please log in to view your job opportunities.
            </p>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="container mx-auto px-6 py-8 animate-fade-in">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-chart-4">
                    {Math.round(stats.sync_percentage)}%
                  </p>
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        ...
        >
          {discovering ? <LoadingSpinner size="sm" /> : <SearchIcon />}
          <span>
            {discovering ? 'Discovering...' : 'Discover New Opportunities'}
          </span>
        </Button>
        ...
        <Card>
          <CardContent className="text-center p-8">
            ...
            <p className="text-muted-foreground mb-4">
              Click "Discover New Opportunities" to scan your emails for job
              postings.
            </p>
