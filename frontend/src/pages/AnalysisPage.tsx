import { Lens, LensArea, Pebble, Signal, StatusBadge, Stone } from '@/components/ui';
  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto min-h-screen bg-[var(--color-specimen-night)]">
      ...
      <Stone
        mode="laboratory"
        elevation="raised"
        className="mb-8 border-[var(--color-eucalypt-smoke-base)]/20"
      >
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 py-2">
            ...
            <span className="text-[var(--color-flannel-flower-dark)] text-xs font-annotation font-bold tracking-widest opacity-40 uppercase">
              OR Manual Context
            </span>
            <div className="h-0.5 bg-white/5 flex-1"></div>
          </div>
          ...
          <LensArea
            ...
            className={`w-full ${jobUrl ? 'opacity-60' : ''}`}
          />
      ...
      {strategyResult && strategyResult.corporate_profile && (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <Stone
            mode="gallery"
            elevation="raised"
            className="overflow-hidden border border-[var(--color-eucalypt-smoke-base)]/20 p-0"
          >
            <div className="p-8 bg-gradient-to-br from-[var(--color-wattle-gold)]/10 to-transparent flex items-center gap-6 border-b border-white/5">
      ...
      {(strategyResult || atsResult) && (
        <div className="mt-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
          <Stone
            mode="laboratory"
            elevation="raised"
            className="bg-[var(--color-specimen-night)] border-[var(--color-wattle-gold)]/20 p-0"
            header={
              <div className="flex justify-between items-center w-full">
                <div>
                  <h3 className="text-xl font-bold text-[var(--color-parchment)] flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-[var(--color-wattle-gold)]" /> ✨ Optimized
                    Output
                  </h3>
                  <p className="text-xs text-[var(--color-flannel-flower-dark)] mt-0.5">
                    Strategic resume ready for submission.
                  </p>
                </div>
                <Pebble
                  variant="secondary"
          ...
          >
            <div className="font-field-note text-base text-[var(--color-parchment)]/90 bg-white/5 p-8 rounded-stone border border-white/5 whitespace-pre-wrap leading-relaxed shadow-inner">
