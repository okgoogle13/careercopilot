...
import { User, Bell, Shield, Trash2, Moon, Globe } from 'lucide-react';
import { Separator } from '@/components/ui/dropdown-menu'; // Reusing separator style if needed or can just use hr/div
            ...
            <div className="min-h-screen bg-surface p-6 md:p-8">
                <div className="mx-auto max-w-[1000px] space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground font-body">Manage your account preferences and application settings.</p>
                    </div>
