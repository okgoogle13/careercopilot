...
const mockCareerData = {
    ...
    Master_Skills_Inventory: [
        { Skill_Name: 'React', Category: 'Frontend', Subtype: ['Frameworks'], Proficiency: 'Expert', Years_Experience: 8 },
        { Skill_Name: 'TypeScript', Category: 'Languages', Subtype: ['Web'], Proficiency: 'Expert', Years_Experience: 6 },
    ],
    Career_Entries: [
        {
            Entry_ID: 'work-1',
            ...
            EndDate: 'Present',
            Location: 'Remote',
            Core_Responsibilities_Scope: 'Led a team of 15 developers in rebuilding the core platform UI.',
    ...
    KSC_Responses: [
        {
            ...
            Improvement_Suggestions: {
                Result: 'The feature was delivered 2 days ahead of schedule, resulting in a successful client launch.',
            }
        }
    ],
};
...
export const ErrorState: Story = {
    decorators: [
        (Story) => {
            window.fetch = async () => {
                return new Response(
                    JSON.stringify({ detail: 'File format not supported or corrupted.' }),
                    { status: 400 }
                );
            };
            return <Story />;
