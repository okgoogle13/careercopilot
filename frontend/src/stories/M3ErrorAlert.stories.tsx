...
export const LongMessage: Story = {
    args: {
        message: 'The server responded with a 500 status code. This might be due to a temporary outage or maintenance. Our engineers have been notified and are working on a fix. Please try again in a few minutes or contact support if the problem persists.',
        onRetry: () => { },
        onDismiss: () => { },
    },
};
