    ...
    <div className="relative z-20 w-full h-full flex flex-col items-center justify-center p-12 text-center">
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="h-32 bg-surface-specimen-night-dark rounded-lg flex items-center justify-center text-sm border border-dashed border-secondary-flannel-dim opacity-50">
            Step 1
          </div>
          <div className="h-32 bg-surface-specimen-night-dark rounded-lg flex items-center justify-center text-sm border border-dashed border-secondary-flannel-dim opacity-50">
            Step 2
