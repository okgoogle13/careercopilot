...
export const GalleryAuth: React.FC = () => {
  return (
    <div className="relative z-20 w-full h-full flex flex-col items-center justify-center p-8 text-center bg-surface-specimen-night-light/50 backdrop-blur-sm rounded-[var(--radius-stone)] border border-primary-wattle-gold/20 max-w-md mx-auto mt-20">
      <motion.div
