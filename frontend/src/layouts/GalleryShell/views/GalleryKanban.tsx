...
export const GalleryKanban: React.FC = () => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between pb-2 border-b border-white/10 sticky top-0 bg-surface-specimen-night/50 backdrop-blur-sm z-10 px-2 rounded-t-lg">
                <h3 className="font-field-note font-bold text-secondary-flannel-flower uppercase text-xs tracking-widest">
                  {col}
                </h3>
                <span className="text-[10px] bg-white/5 px-2 py-0.5 rounded-full text-secondary-flannel-dim">
                  {colApps.length}
                </span>
              </div>
              ...
              <div className="flex-1 flex flex-col gap-4 overflow-y-auto no-scrollbar p-1">
                  ...
                  >
                    ...
                    >
                      <div className="flex flex-col gap-2">
                        <h4 className="font-bloom text-lg text-parchment group-hover:text-wattle-gold transition-colors">
                          {app.role}
                        </h4>
                        <div className="text-sm font-body text-secondary-flannel-flower">
                          {app.company}
                        </div>
                ...
                {colApps.length === 0 && (
                  <div className="h-32 border-2 border-dashed border-white/5 rounded-lg flex flex-col items-center justify-center text-center p-4 opacity-50">
                    <span className="font-handwriting text-2xl text-secondary-flannel-dim rotate-[-5deg] mb-2">
                      Empty...
                    </span>
                    <span className="text-xs font-annotation text-secondary-flannel-flower">
                      No specimens here yet
                    </span>
                  </div>
                )}
              </div>
