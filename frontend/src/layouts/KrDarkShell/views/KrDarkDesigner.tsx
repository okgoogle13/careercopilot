  ...
  return (
    <div className="relative z-20 w-full h-[90vh] flex flex-col overflow-hidden bg-asphalt-black">
      ...
      <motion.div 
        ...
        className="h-20 bg-asphalt-black border-b border-white/5 flex items-center px-10 gap-6 shadow-viscous"
      >
        <div className="flex gap-3 pr-6 border-r border-white/5">
          <ActionButton variant="secondary" label="SELECT" size="sm" className="px-4 py-2 text-[9px] tracking-widest" />
          <ActionButton variant="secondary" label="LAYOUT" size="sm" className="px-4 py-2 text-[9px] tracking-widest" />
          <ActionButton variant="secondary" label="PREVIEW" size="sm" className="px-4 py-2 text-[9px] tracking-widest" />
        </div>
        ...
        <div className="ml-auto flex gap-4">
          <ActionButton variant="primary" label="EXPORT MANIFEST" size="sm" className="px-8 py-2 text-[9px] tracking-widest" />
        </div>
      </motion.div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <motion.div 
          ...
          className="w-80 bg-asphalt-black border-r border-white/5 p-8 flex flex-col gap-8 overflow-y-auto custom-scrollbar"
        >
           <div className="space-y-2">
             <h4 className="text-[10px] font-annotation uppercase tracking-[0.4em] text-paper-white/40">Asset Reservoir</h4>
        ...
        <div className="flex-1 bg-asphalt-black p-16 overflow-hidden flex items-center justify-center relative group">
          ...
          <SolidarityCard className="w-full h-full max-w-5xl max-h-[90%] border-dashed border-white/10 flex flex-col items-center justify-center bg-asphalt-black/40 backdrop-blur-[2px] relative cursor-crosshair">
            <div className="absolute inset-4 border border-white/5 rounded-stone border-dashed pointer-events-none opacity-40" />
            ...
            <div className="absolute bottom-8 right-8 pointer-events-none">
              <span className="font-mono text-[8px] uppercase tracking-widest text-paper-white/10">STATION_V4_CORE</span>
            </div>
          </SolidarityCard>
        </div>
      </div>
