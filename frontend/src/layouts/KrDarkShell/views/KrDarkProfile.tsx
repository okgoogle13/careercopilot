    ...
    <div className="relative z-20 w-full max-w-6xl mx-auto p-8 md:p-16 flex flex-col items-center gap-16 overflow-hidden">
      ...
      >
        <div className="relative group">
          ...
          <div className="w-56 h-56 rounded-march bg-asphalt-black border-4 border-[var(--kr-color-charcoal-background-steps-3)]/20 flex items-center justify-center overflow-hidden shadow-viscous group-hover:border-ink-gold/20 transition-all duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
        {stats.map((stat, idx) => (
          ...
          >
            <SolidarityCard className="p-10 flex flex-col items-center gap-4 group hover:border-[var(--kr-color-charcoal-background-steps-3)]/30 transition-colors">
              ...
              <div className="mt-2 h-0.5 w-8 rounded-march bg-[var(--kr-color-charcoal-background-steps-3)]/25" />
            </SolidarityCard>
          </motion.div>
        ))}
      </div>
      ...
      >
        <SolidarityCard className="w-full p-12 flex flex-col gap-10">
          <div className="flex justify-between items-center border-b border-[var(--kr-color-charcoal-background-steps-3)]/20 pb-8">
