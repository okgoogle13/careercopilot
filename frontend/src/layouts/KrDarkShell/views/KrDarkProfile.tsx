  ...
  return (
    <div className="relative z-20 w-full max-w-6xl mx-auto p-8 md:p-16 flex flex-col items-center gap-16 overflow-hidden">
      ...
      <div className="flex gap-6 mt-8">
        <ActionButton variant="secondary" label="DOWNLOAD MANIFESTO" className="px-10 py-4 text-[10px] tracking-widest" />
        <ActionButton variant="primary" label="MODIFY RECORD" className="px-16 py-4 text-[10px] tracking-[0.2em] shadow-viscous" />
      </div>
    </div>
  );
};
