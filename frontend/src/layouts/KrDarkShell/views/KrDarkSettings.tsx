  ...
  const categories = [
    {
      ...
      settings: [
        { label: 'Broadcast Profile', desc: 'Make your solidarity record visible to the collective.', active: true },
        { label: 'Tactical Anonymity', desc: 'Mask precise metadata from lower-tier probes.', active: false },
      ]
    },
    {
      id: 'interface',
      ...
      settings: [
        { label: 'Dark Mode Substrate', desc: 'Use the deep charcoal aesthetic by default.', active: true },
        { label: 'High-Contrast Defiance', desc: 'Enhance visibility for critical mission parameters.', active: false },
      ]
    }
  ];
  ...
  return (
    <div className="relative z-20 w-full max-w-5xl mx-auto p-8 md:p-16 flex flex-col gap-16 overflow-hidden">
      ...
      <div className="text-center opacity-10">
        <span className="font-mono text-[8px] uppercase tracking-[0.5em]">SYSTEM_VERSION: 4.0.12 // SUBSTRATE_HASH: 0x82C7</span>
      </div>
    </div>
  );
};
