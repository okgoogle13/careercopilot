    ...
    <div className="relative z-20 w-full max-w-5xl mx-auto p-8 md:p-16 flex flex-col gap-16">
      ...
      >
        <div className="relative group cursor-pointer">
          ...
          <div className="flex flex-col items-center justify-center p-24 border-2 border-dashed border-[var(--kr-color-charcoal-background-steps-3)]/25 rounded-megaphone bg-asphalt-black/40 backdrop-blur-sm group-hover:border-solidarity-red/40 transition-all duration-700 shadow-viscous group-hover:shadow-ink-glow">
            <div className="mb-8 relative">
              <div className="w-20 h-20 rounded-march border border-[var(--kr-color-charcoal-background-steps-3)]/30 flex items-center justify-center text-paper-white/20 group-hover:text-solidarity-red group-hover:border-solidarity-red/40 transition-colors duration-500">
                <svg
                  className="w-10 h-10"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <ActionButton
              variant="secondary"
              label="BROWSE ARCHIVE_01"
              className="px-10 py-3 text-[10px] tracking-[0.3em]"
            />
      ...
      >
        <ActionButton
          ...
          className="px-16 py-5 text-sm tracking-widest shadow-viscous"
        />
      </motion.div>
