          ...
          >
            ...
            >
              <div className="space-y-1">
                ...
                <p className="font-mono text-[10px] text-paper-white/10 uppercase tracking-widest">{m.ref}</p>
              </div>

              <div className={`text-5xl font-bloom ${m.color} tracking-tighter group-hover:scale-105 transition-transform duration-700 relative z-10`}>
                <ValueReveal value={m.value} shouldReduceMotion={shouldReduceMotion} />
              </div>
      ...
      >
        <SolidarityCard className="w-full p-12 relative overflow-hidden bg-asphalt-black group">
          ...
          <div className="mt-10 flex justify-center">
             <ActionButton variant="secondary" label="OPEN FULL ARCHIVE" className="px-12 py-4 text-[10px] tracking-widest" />
          </div>
        </SolidarityCard>
      </motion.div>
