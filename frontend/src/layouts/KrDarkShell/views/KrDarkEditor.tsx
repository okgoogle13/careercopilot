      ...
      >
        <div className="flex items-center gap-6">
          <div className="flex gap-2">
            <div className="w-3 h-3 rounded-full bg-waratah-red/60" />
            <div className="w-3 h-3 rounded-full bg-wattle-gold/60" />
  ...
  threshold: 0.95`}
        ...
        >
          <SolidarityCard className="w-full h-full p-0 flex flex-col bg-asphalt-black overflow-hidden group">
            <div className="bg-wattle-gold/5 px-6 py-3 border-b border-white/5 group-hover:bg-wattle-gold/10 transition-colors flex justify-between">
              <span className="font-annotation text-[9px] uppercase tracking-widest text-wattle-gold/60">Extracted Preview</span>
              <div className="flex gap-4">
                <div className="w-2 h-2 rounded-full bg-wattle-gold animate-pulse" />
                <span className="font-mono text-[9px] text-wattle-gold/40">SYNC_ACTIVE</span>
              </div>
            </div>
            
            <div className="flex-1 flex flex-col items-center justify-center gap-8 relative">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-wattle-gold/5 via-transparent to-transparent pointer-events-none" />
              <div className="w-24 h-24 rounded-full border border-wattle-gold/20 flex items-center justify-center">
                {!shouldReduceMotion && <div className="w-16 h-16 rounded-full border border-wattle-gold animate-ping opacity-20" />}
              </div>
