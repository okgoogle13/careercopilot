    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 flex-1 overflow-y-auto">
        <div className="mb-6 relative">
          <div className="relative rounded-xl overflow-hidden shadow-lg border-2 border-surface-laboratory-slate-smoke-highest bg-surface-laboratory-charcoal-slate max-w-[120px] mx-auto">
            <img
              src="/src/assets/specimens/lab-sentry.png"
