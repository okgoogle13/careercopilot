...
interface kr-darkDockProps {
    currentView: string;
    onViewChange: (view: string) => void;
}

export const kr-darkDock: React.FC<kr-darkDockProps> = ({ currentView, onViewChange }) => {
        ...
        >
            {navItems.map((item) => {
              ...
              ${isActive
                                ...
                                : 'text-paper-white hover:bg-surface-kr-dark-concrete-grey-high/50'}
            `}
                    >
                        {item.label}
                    </button>
