...
import { Navigation, Eye, FileText, Loader2, BarChart3, Layout, Layers, Play, Sparkles, Settings as SettingsIcon, Users, TrendingUp, MessageSquare, Upload, Target, LogIn } from "lucide-react";
              ...
              <div className="p-4">
                ...
                <div className="mt-3 pt-3 border-t border-border">
                  <p className="text-xs text-muted-foreground">
                    Explore the complete Career Copilot user journey from authentication to document creation to career growth.
                  </p>
                </div>
              </div>
            </Card>
