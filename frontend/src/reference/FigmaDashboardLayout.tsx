...
const plantImage = ""; // Placeholder to prevent build error
        ...
        <div className="p-12 max-w-7xl">
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-[var(--on-surface)] text-xl max-w-lg tier-body">You have 3 upcoming interviews this week.</p>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 h-[65%] pointer-events-none">
                    <div
                        ...
                        style={{
                            ...
                            mixBlendMode: 'screen',
                            opacity: 0.65,
                            WebkitMaskImage: 'linear-gradient(to top, transparent 0%, rgba(0,0,0,0.3) 5%, rgba(0,0,0,0.6) 15%, rgba(0,0,0,0.85) 25%, black 40%)',
                            maskImage: 'linear-gradient(to top, transparent 0%, rgba(0,0,0,0.3) 5%, rgba(0,0,0,0.6) 15%, rgba(0,0,0,0.85) 25%, black 40%)'
                        }}
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                >
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <p className="text-[var(--on-surface-variant)] text-[0.75rem] tier-data">Active Applications</p>
                    </div>
                </motion.div>
                ...
                >
                    <div className="relative z-10 flex flex-col items-center">
                        <svg className="w-12 h-12 text-[var(--primary-sage)] mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                        </svg>
                        <p className="text-7xl mb-6 text-[var(--on-surface)] tier-data">2</p>
                        <p className="text-[var(--on-surface-variant)] text-[0.75rem] tier-data">Offers Received</p>
                    </div>
                </motion.div>
                        ...
                        >
                            <div className="relative z-10">
                                <div className="mb-4">
                                    ...
                                    <p className="text-[var(--on-surface-variant)] text-[0.7rem] tier-data">{profile.company}</p>
                                </div>
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-3xl text-[var(--primary-sage)] tier-data">{profile.score}</p>
                                        <p className="text-[var(--on-surface-variant)] text-[0.7rem] tier-data">ATS Score</p>
                                    </div>
                                    <div className={`px-4 py-2 rounded-full text-sm tier-data ${profile.score >= 90 ? 'bg-[#8A9A5B]/20 text-[#8A9A5B]' :
