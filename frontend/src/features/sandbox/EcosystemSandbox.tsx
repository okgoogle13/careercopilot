...
export function EcosystemSandbox() {
    ...
    return (
        <GardenLayout>
            <NativeAnchor variant="fern" anchor="ceiling-left" className="opacity-60" />
...
>>>>>>> restoration-KR-Rage-Figma-v2.0
                    ...
                    <div className="bg-surface-container-high/50 p-1 rounded-full flex gap-1 border border-white/10 shadow-sm backdrop-blur-md">
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full text-label-small font-bold transition-all ${archetype === 'gov'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full text-label-small font-bold transition-all ${archetype === 'corp'
