        ...
        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="p-8 bg-surface-container rounded-pebble border border-outline-variant shadow-elevation-1 
                        ...
                        <div className="flex flex-wrap gap-4 items-center">
                            ...
                            <KeywordTag keyword="Tag Item" className="rounded-pebble hover:rotate-3 transition-transform ease-spring" />
                        ...
                        <p className="mt-6 text-on-surface-variant">
                            Friendly, soft asymmetry. Used for interactive elements where touch physics is implied.
                            <br />
                    ...
                    {/* Card: The Gem */}
                    <div className="p-12 bg-atmospheric-vibrant text-on-surface rounded-gem shadow-elevation-3 relative overflow-hidden group
            ...
            <section className="mb-16 animate-in slide-in-from-bottom-8 fade-in duration-700 delay-300 ease-spring-decelerate fill-mode-both">
                ...
                <div className="bg-surface-container p-8 rounded-leaf border border-outline-variant space-y-8">
                    <div className='group'>
                        <p className="text-label-small uppercase tracking-widest text-on-surface-variant mb-2">Display Large (Weight 900)</p>
                    ...
                    <div className='group'>
                        <p className="text-label-small uppercase tracking-widest text-on-surface-variant mb-2">Contrast Demo</p>
