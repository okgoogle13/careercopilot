...
export function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center text-center px-6 relative overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-march blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-tertiary/10 rounded-march blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-xl relative z-10">
        ...
        <div className="relative mb-8">
          <div className="flex justify-center mb-6">
            <div className="p-4 bg-white/5 rounded-march ring-1 ring-white/10 animate-pulse">
