...
const GlassLeafCard = React.forwardRef<HTMLDivElement, GlassLeafCardProps>(
    ({ className, children, intensity = 'medium', ...props }, ref) => {
        ...
        // kr-screenprint intensity mapping
        const blurIntensity = {
        ...
        const bgOpacity = {
            light: mode === 'kr-dark' ? 'bg-surface-kr-dark-glass-medium/60' : 'bg-surface-kr-dark-glass-medium/60',
            medium: mode === 'kr-dark' ? 'bg-surface-kr-dark-glass-medium/75' : 'bg-surface-kr-dark-glass-medium/80',
            heavy: mode === 'kr-dark' ? 'bg-surface-kr-dark-glass-medium/90' : 'bg-surface-kr-dark-glass-medium/90',
        };
        ...
        return (
            <motion.div
                ...
                style={{
                    borderRadius: mode === 'kr-dark' ? 'var(--radius-leaf)' : '12px',
                    boxShadow: mode === 'kr-dark'
