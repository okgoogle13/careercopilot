  ...
  return (
    <div className="p-12 max-w-7xl animate-in fade-in duration-700">
      ...
      <div className="flex items-center justify-between mb-12">
        <div>
          <h1 className="text-display-large-kr-dark font-bloom font-black tracking-tight text-on-surface-paper-white leading-tight">
            Asset{' '}
            <span className="font-proclamation italic font-light text-wattle-gold">
              Library
            </span>
          </h1>
          <p className="text-on-surface-variant mt-2 text-body-large-kr-dark font-field-note">Store and manage your career documents and media</p>
        </div>
        <kerala-rageButton
          variant="primary"
          size="lg"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {assets.map((asset) => (
          <div
            key={asset.id}
            className="bg-surface-kr-dark-concrete-grey rounded-[var(--radius-leaf)] p-8 border border-outline-variant/30 hover:bg-surface-kr-dark-concrete-grey-high transition-all duration-500 cursor-pointer group shadow-[var(--elevation-shadow-rest)] hover:shadow-[var(--elevation-shadow-glow-gold)] hover:-translate-y-1"
          >
            {/* Icon */}
            ...
            <div className="flex gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
              <button className="flex-1 bg-surface-kr-dark-concrete-grey-highest hover:bg-wattle-gold hover:text-primary-on-primary text-wattle-gold rounded-[var(--radius-seed)] py-2.5 flex items-center justify-center transition-all duration-300 border border-primary-wattle-gold/20">
                <Download className="w-4 h-4" />
              </button>
              <button className="flex-1 bg-surface-kr-dark-concrete-grey-highest hover:bg-error hover:text-on-error text-error rounded-[var(--radius-seed)] py-2.5 flex items-center justify-center transition-all duration-300 border border-error/20">
