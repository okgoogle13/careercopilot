  ...
  return (
    <div
      ...
      ${variant === 'outlined'
          ...
          : 'bg-[var(--sys-color-charcoalBackground-base)]'
        }
      ${elevationClasses}
    ...
    >
      <div className="flex items-center gap-3 mb-3">
        <motion.div
          className="w-10 h-10 bg-[var(--sys-color-charcoalBackground-base)]-light rounded-seed flex items-center justify-center text-ink-gold"
