...
const GlassLeafCard = React.forwardRef<HTMLDivElement, GlassLeafCardProps>(
    ({ className, children, intensity = 'medium', ...props }, ref) => {
        ...
        // KrScreenprint intensity mapping
        const blurIntensity = {
        ...
        const bgOpacity = {
            light: mode === 'KrDark' ? 'bg-surface-KrDark-glass-medium/60' : 'bg-surface-KrDark-glass-medium/60',
            medium: mode === 'KrDark' ? 'bg-surface-KrDark-glass-medium/75' : 'bg-surface-KrDark-glass-medium/80',
            heavy: mode === 'KrDark' ? 'bg-surface-KrDark-glass-medium/90' : 'bg-surface-KrDark-glass-medium/90',
        };
