...
export const EvidenceCard: React.FC<EvidenceCardProps> = ({
    ...
    return (
        <motion.div
            className={`group relative cursor-pointer overflow-hidden rounded-tech border-2 p-6 transition-all ${isSelected
        ...
        >
            ...
            {/* Content */}
            <p className="font-leaf mb-4 text-sm leading-relaxed text-white/80">
                {content}
            </p>
