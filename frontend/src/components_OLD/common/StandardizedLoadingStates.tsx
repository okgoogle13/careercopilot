      ...
      <Card className={cn('p-6', className)}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            <Skeleton variant="text" style={{ width: '75%', height: 20 }} className="mb-2" />
            <Skeleton variant="text" style={{ width: '50%', height: 16 }} />
          </div>
        </div>
        <Skeleton variant="rect" style={{ width: '100%', height: 100 }} className="mb-4" />
        <Skeleton variant="text" style={{ width: '100%', height: 16 }} className="mb-2" />
        <div className="flex gap-2 pt-2">
          <Skeleton variant="circle" style={{ width: 24, height: 24 }} />
          <Skeleton variant="circle" style={{ width: 24, height: 24 }} />
        </div>
        <Skeleton variant="text" style={{ width: '100%', height: 16 }} className="mt-4" />
      </Card>
    );
  }
      ...
      <div className={cn('space-y-3', className)}>
        {Array.from({ length: 5 }).map((_, i) => (
          ...
          >
            ...
            <div className="flex-1">
              <Skeleton variant="text" style={{ width: '75%', height: 16 }} className="mb-2" />
              <Skeleton variant="text" style={{ width: '50%', height: 14 }} />
            </div>
          </div>
        ))}
      </div>
    ...
    return (
      <Card className={cn('p-6', className)}>
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <Skeleton variant="text" style={{ width: '60%', height: 24 }} className="mb-2" />
            <Skeleton variant="text" style={{ width: '40%', height: 20 }} className="mb-2" />
            <Skeleton variant="text" style={{ width: '30%', height: 16 }} />
          </div>
        </div>
        <div className="space-y-2">
          <Skeleton variant="text" style={{ width: '100%', height: 16 }} />
          <Skeleton variant="text" style={{ width: '90%', height: 16 }} />
          <Skeleton variant="text" style={{ width: '80%', height: 16 }} />
        </div>
      </Card>
    );
  }
