...
export const ManifestoCard: React.FC<ManifestoCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Hero Title */}
      <h2 className={cn('mb-8', 'text-display-lg font-solidarity-800 text-solidarity-red')}>
        {title}
      </h2>

      {/* Body Content */}
      <p className={cn('mb-12', 'text-body-lg font-direct-action-450 text-paper-white/80')}>
        {content}
      </p>
      ...
      {actionLabel && (
        <motion.button
          ...
          className={cn(
            ...
            'bg-ink-gold text-charcoal shadow-hover-rise rounded-pebble',
