...
const NavItem = memo<NavItemProps>(({ to, label, icon, isPrimary = false, onMobileMenuClose }) => (
  <NavLink
    to={to}
        ...
        <div className='container mx-auto px-6'>
          <div className='flex justify-between items-center h-16'>
            ...
            >
              ...
              <span className='gradient-text font-bold text-2xl tracking-tight'>CareerCopilot</span>
            </NavLink>

            {/* Desktop Navigation */}
            <div className='hidden md:flex items-center space-x-2'>
              {navigationItems.map(item => (
                <NavItem key={item.to} {...item} onMobileMenuClose={handleMobileMenuClose} />
              ))}
            </div>
