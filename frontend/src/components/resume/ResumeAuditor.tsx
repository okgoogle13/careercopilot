  ...
  return (
    <div className="tech-card p-lg bg-asphalt-black border border-concrete-grey-dark">
      ...
      <div className="mb-md">
        ...
        <textarea
          className="w-full min-h-[300px] p-md bg-asphalt-black-light text-body text-concrete-grey-lightest border border-concrete-grey-dark rounded-md font-mono text-sm"
      ...
      <div className="mb-md">
        ...
        <textarea
          className="w-full min-h-[150px] p-md bg-asphalt-black-light text-body text-concrete-grey-lightest border border-concrete-grey-dark rounded-md font-mono text-sm"
