    ...
    <div className="tech-card p-lg bg-asphalt-black border border-concrete-grey-dark">
      ...
      <div className="flex justify-between items-start mb-lg">
        <div>
          ...
          <div className="flex gap-md text-xs">
            <span className="text-waratah-red">{severityCounts.error} errors</span>
            <span className="text-wattle-gold">{severityCounts.warning} warnings</span>
            <span className="text-concrete-grey-light">{severityCounts.info} suggestions</span>
          </div>
        </div>

        <div className="text-right">
          <div className="text-4xl text-wattle-gold font-bold mb-xs">{overallScore}/100</div>
          <button
      ...
      {scanSimulation && (
        <div className="mb-lg p-md bg-asphalt-black-light border-l-4 border-wattle-gold">
          <h4 className="text-body-bold text-wattle-gold mb-xs">10-Second Recruiter Scan</h4>
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start mb-xs">
                <code className="text-mono text-xs text-wattle-gold">{violation.ruleId}</code>
                <span
