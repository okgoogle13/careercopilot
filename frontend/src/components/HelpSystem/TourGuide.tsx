    ...
    steps: [
      {
        ...
        description:
          "This is your main dashboard where you can manage all your career documents and profiles. Let's explore the key features.",
        position: 'bottom',
      },
      {
        id: 'create-profile',
        ...
        description:
          'Click here to create different versions of your profile optimized for specific job types or industries.',
      ...
      },
      {
        ...
        description:
          'Each card represents a different version of your professional profile. You can edit, delete, or create variations from here.',
      ...
      },
      {
        ...
        description:
          'Use the navigation bar to access different sections: Documents, Analysis, Opportunities, and Settings.',
    ...
    steps: [
      {
        ...
        description:
          'Your profile is organized into sections. Each section focuses on a different aspect of your professional background.',
      ...
      },
      {
        ...
        description:
          'Start with your basic contact information and professional details. This forms the foundation of all your documents.',
      ...
      },
      {
        ...
        description:
          'Add your work history with detailed descriptions and achievements. Use action verbs and quantify your accomplishments.',
      ...
      },
      {
        ...
        description:
          'List your technical skills, soft skills, and certifications. These are crucial for ATS keyword matching.',
      ...
      },
      {
        ...
        title: 'Job Targeting',
        description:
          'Specify target roles and keywords. This helps optimize your profile for specific job applications.',
      ...
      },
      {
        ...
        description:
          'Your changes are automatically saved. Look for the "Unsaved changes" indicator to see when changes are pending.',
    ...
    steps: [
      {
        ...
        description:
          'Paste the complete job posting here. Our AI will analyze the requirements and optimize your documents accordingly.',
      ...
      },
      {
        ...
        title: 'ATS Analysis',
        description:
          'Get an instant compatibility score before generating your documents. This helps ensure your application will pass ATS filters.',
      ...
      },
      {
        ...
        description:
          'Choose from professional templates designed for different industries and career levels.',
      ...
      },
      {
        ...
        title: 'Live Preview',
        description:
          'See how your document will look before downloading. You can make adjustments and regenerate as needed.',
    ...
    <>
      ...
      >
        ...
        <div className='flex items-center justify-between'>
          ...
          <Button onClick={nextStep} size='sm' className='flex items-center gap-1'>
