...
export const HelpModal: React.FC<HelpModalProps> = ({ content, options: _options, onDismiss }) => {
  useEffect(() => {
    ...
    <Modal isOpen={true} onClose={onDismiss} size='md'>
      <div className='p-6'>
        ...
        <div className='text-gray-700 leading-relaxed mb-6'>
          <div className='prose prose-sm max-w-none'>{formatDescription(content.description)}</div>
        </div>
