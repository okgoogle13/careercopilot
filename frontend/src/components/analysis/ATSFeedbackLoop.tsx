...
export const ATSFeedbackLoop: React.FC<ATSFeedbackLoopProps> = ({
      ...
      const mockResult: ATSAnalysisResult = {
        ...
        breakdown: {
          keywordMatch: {
            ...
            maxScore: 25,
            details: [
              'Missing 7 key technical terms',
              'Good industry keyword coverage',
              'Role-specific terms need improvement',
            ],
          },
          formatting: {
            score: 23,
        ...
        recommendations: [
          {
            ...
            description:
              'Your resume is missing several key technical terms that appear frequently in the job description. Adding these will significantly improve your ATS score.',
            impact: 'high',
            effort: 'low',
            ...
            after:
              'Developed scalable web applications using React, Node.js, and TypeScript, deployed on AWS with Docker containers',
            implemented: false,
          },
          {
            id: '2',
            ...
            description:
              'A clearly labeled skills section helps ATS systems categorize your expertise and improves keyword matching.',
            impact: 'high',
            effort: 'medium',
            implemented: false,
          },
          {
            ...
            description:
              'Add specific numbers and percentages to more of your accomplishments to stand out.',
            impact: 'medium',
            effort: 'medium',
          ...
          },
          {
            ...
            description:
              'Modern ATS systems also look for soft skills mentioned in job descriptions.',
            impact: 'medium',
            effort: 'low',
  ...
  const handleOptimizeDocument = async () => {
    ...
    try {
        ...
        prev
          ? {
              ...
              recommendations: prev.recommendations.map(rec =>
                selectedRecommendations.has(rec.id) ? { ...rec, implemented: true } : rec
              ),
            }
          : null
      );
      ...
      toast.success(
        `Document optimized! Score improved from ${analysisResult.score} to ${newScore}`
      );
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
              ...
              <div>
                ...
                <div className='font-semibold'>
                  {analysisResult.competitorAnalysis.averageScore}
                </div>
              </div>
              <div>
                <div className='text-muted-foreground'>Top 10%</div>
                <div className='font-semibold'>
                  {analysisResult.competitorAnalysis.topPerformers}
                </div>
              </div>
              <div>
                <div className='text-muted-foreground'>Your Ranking</div>
                <div className='font-semibold'>
                  #{analysisResult.competitorAnalysis.yourRanking}
                </div>
              </div>
            </div>
          </div>
        ...
        <Card className='p-6'>
          <div className='flex items-center justify-between mb-6'>
            ...
            <div className='flex gap-2'>
              <Button
                onClick={() =>
                  setSelectedRecommendations(new Set(pendingRecommendations.map(r => r.id)))
                }
                variant='outline'
                size='sm'
              >
                ...
                <div>
                  ...
                  <p className='text-blue-700 text-sm'>
                    ...
                    {pendingRecommendations
                      ...
                      .reduce(
                        (total, rec) =>
                          total + (rec.impact === 'high' ? 8 : rec.impact === 'medium' ? 5 : 2),
                        0
                      )}{' '}
                    points
                  </p>
