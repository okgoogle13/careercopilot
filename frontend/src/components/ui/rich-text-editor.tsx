...
export function SimpleRichTextEditor({ basicToolbar = true, ...props }: SimpleRichTextEditorProps) {
  return <RichTextEditor {...props} showToolbar={basicToolbar} toolbarClassName='p-1' />;
}
