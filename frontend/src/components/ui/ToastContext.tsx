/**
 * ELECTRIC ALCHEMIST: TOAST CONTEXT
 *
 * Toast context provider and hook for managing toast notifications.
 * Uses Electric Alchemist design system Toast component.
 */

import React, { createContext, useContext, useState, useCallback, type ReactNode } from 'react';
import { Toast, ToastProps, type ToastSeverity } from './Toast';
