    ...
    <div className='mt-8 pt-6 border-t border-gray-200'>
      ...
      <div className='space-y-4'>
        {suggestions.map((suggestion, index) => (
          ...
          >
            ...
            <div className='mb-3'>
              <span className='font-semibold text-gray-700 text-sm'>💼 Suggested Location:</span>
              <p className='text-gray-800 mt-1 font-medium'>{suggestion.suggested_location}</p>
            </div>
      ...
      <div className='mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg'>
        <p className='text-sm text-yellow-800'>
          <strong>💡 Pro Tip:</strong> When incorporating these keywords, make sure they fit
          naturally within the context of your experience. Avoid keyword stuffing and focus on
          authentic descriptions of your skills and accomplishments.
        </p>
      </div>
    </div>
  );
