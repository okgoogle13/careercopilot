    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.illustrationLayer}>
                <img src={monstera} alt="" className={styles.plantTopLeft} />
                <img src={snakePlant} alt="" className={styles.plantTopRight} />
                <img src={fiddleLeaf} alt="" className={styles.plantBottomLeft} />
                <img src={pilea} alt="" className={styles.plantBottomRight} />
            </div>
            ...
            <main className={styles.heroCard}>
                ...
                <div className={styles.actionContainer}>
                    <Link to="/login" className={styles.btnFilled}>
                        Sign In
                    </Link>
                    <Link to="/register" className={styles.btnOutlined}>
                        Register
                    </Link>
                </div>
            </main>
