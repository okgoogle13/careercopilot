...
const TemplateGallery: React.FC<TemplateGalleryProps> = ({
    ...
    const mockTemplates: Template[] = [
      {
        ...
        level: 'mid',
        description:
          'A timeless, clean design perfect for traditional industries and corporate positions.',
        features: [
          'Clean typography',
          'Conservative layout',
          'ATS-optimized',
      ...
      },
      {
        ...
        level: 'senior',
        description:
          'A bold, visual design perfect for creative professionals who want to stand out.',
  ...
  const categories = [
    ...
    },
    {
      id: 'executive',
      name: 'Executive',
      count: templates.filter(t => t.category === 'executive').length,
    },
    {
      id: 'technical',
      name: 'Technical',
  ...
  const levels = ['all', 'entry', 'mid', 'senior', 'executive'];
          ...
          <div>
            ...
            <div className='flex items-center gap-4 text-sm text-gray-600'>
              <span className='capitalize'>
                {template.category} • {template.level} level
              </span>
              <div className='flex items-center gap-1'>
                <Star className='w-4 h-4 text-yellow-500 fill-current' />
                <span>
                  {template.rating} ({template.downloadCount.toLocaleString()} downloads)
                </span>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className='space-y-2'>
                ...
                <div className='flex items-center justify-between text-sm'>
                  ...
                  <span
                    className={template.compatibility.mobile ? 'text-green-600' : 'text-red-600'}
                  >
                ...
                <div className='flex items-center justify-between text-sm'>
                  ...
                  <span
                    className={
                      template.compatibility.applicantTracking ? 'text-green-600' : 'text-red-600'
                    }
                  >
