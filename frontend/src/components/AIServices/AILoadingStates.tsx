...
export const AILoadingState: React.FC<AILoadingStateProps> = ({ type, message }) => {
  ...
  const getDefaultMessage = () => {
    switch (type) {
      case 'job-matching':
        return 'Analyzing your profile and matching with thousands of jobs...';
      case 'content-optimization':
        return 'Optimizing your content with AI-powered enhancements...';
      case 'resume-intelligence':
        return 'Generating deep insights about your career trajectory...';
      case 'cover-letter':
        return 'Crafting a personalized cover letter with company research...';
      default:
    ...
    <Card className='p-8 text-center'>
      <div className='flex justify-center mb-4'>
        <div className='relative'>
          <div className='animate-pulse text-blue-600'>{getIcon()}</div>
      ...
      <p className='text-gray-600 mb-4 max-w-md mx-auto'>{message || getDefaultMessage()}</p>

      <div className='text-sm text-gray-500'>Estimated time: {getEstimatedTime()}</div>
...
export const AIProcessingBackground: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className='relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50'>
    ...
    <div className='absolute inset-0 overflow-hidden pointer-events-none'>
      ...
      <div
        className='absolute top-40 -left-40 w-60 h-60 rounded-full bg-purple-100 opacity-20 animate-pulse'
        style={{ animationDelay: '1s' }}
      ></div>
      <div
        className='absolute bottom-40 right-20 w-40 h-40 rounded-full bg-green-100 opacity-20 animate-pulse'
