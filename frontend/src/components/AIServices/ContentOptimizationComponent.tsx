...
export const ContentOptimizationComponent: React.FC<ContentOptimizationComponentProps> = ({
  ...
  const [optimizationSettings, setOptimizationSettings] = useState({
    ...
    target_company: '',
    target_industry: '',
    optimization_goals: ['ats_optimization', 'keyword_enhancement'] as Array<
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='text-center'>
        <h2 className='text-3xl font-bold text-gray-900 mb-2'>AI Content Optimization</h2>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setOptimizationSettings(prev => ({ ...prev, target_role: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setOptimizationSettings(prev => ({ ...prev, target_company: e.target.value }))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    setOptimizationSettings(prev => ({ ...prev, target_industry: e.target.value }))
                  }
              ...
              <div className='grid grid-cols-2 md:grid-cols-5 gap-2'>
                {Object.entries(optimizationGoalLabels).map(([key, label]) => (
                  <label key={key} className='flex items-center space-x-2'>
                    <input
                      type='checkbox'
                      checked={optimizationSettings.optimization_goals.includes(
                        key as keyof typeof optimizationGoalLabels
                      )}
                      onChange={e => {
                        if (e.target.checked) {
                          setOptimizationSettings(prev => ({
                  ...
                  {results.improvements.map((improvement, index) => (
                    <div key={index} className='border rounded-lg p-4 space-y-2'>
                      ...
                      <div className='space-y-2'>
                        ...
                        <div className='text-sm text-gray-600 italic'>{improvement.reason}</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className='space-y-6'>
              ...
              <Card className='p-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                  <div
                    className={`p-4 rounded-lg ${getScoreBackground(results.metrics.readability_score)}`}
                  >
                    <div
                      className={`text-2xl font-bold ${getScoreColor(results.metrics.readability_score)}`}
                    >
                  ...
                  <div
                    className={`p-4 rounded-lg ${getScoreBackground(results.metrics.ats_score)}`}
                  >
                    <div
                      className={`text-2xl font-bold ${getScoreColor(results.metrics.ats_score)}`}
                    >
                  ...
                  <div
                    className={`p-4 rounded-lg ${getScoreBackground(results.metrics.impact_score)}`}
                  >
                    <div
                      className={`text-2xl font-bold ${getScoreColor(results.metrics.impact_score)}`}
                    >
