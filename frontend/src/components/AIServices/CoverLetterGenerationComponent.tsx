...
export const CoverLetterGenerationComponent: React.FC<CoverLetterGenerationComponentProps> = ({
  ...
  const handleGeneration = useCallback(async () => {
    if (
      ...
      !jobDetails.company_name.trim() ||
      !jobDetails.position_title.trim()
    ) {
    ...
    try {
      const request: SmartCoverLetterRequest = {
        ...
        user_background: {
          ...
          years_experience: userBackground.years_experience
            ? parseInt(userBackground.years_experience)
            : undefined,
  ...
  const updateAchievement = (index: number, value: string) => {
    setUserBackground(prev => ({
      ...prev,
      key_achievements: prev.key_achievements.map((achievement, i) =>
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='text-center'>
        <h2 className='text-3xl font-bold text-gray-900 mb-2'>AI Cover Letter Generator</h2>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value='input' className='space-y-6'>
            ...
            <div className='space-y-4'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setJobDetails(prev => ({ ...prev, company_name: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setJobDetails(prev => ({ ...prev, position_title: e.target.value }))
                    }
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={e =>
                    setJobDetails(prev => ({ ...prev, job_description: e.target.value }))
                  }
                  rows={10}
              ...
              {!resumeDocumentId && (
                <div>
                  ...
                  <textarea
                    ...
                    onChange={e =>
                      setJobDetails(prev => ({ ...prev, resume_content: e.target.value }))
                    }
                    rows={8}
            ...
            <div className='space-y-4'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setUserBackground(prev => ({ ...prev, current_role: e.target.value }))
                    }
              ...
              <div className='w-full md:w-1/2'>
                ...
                <input
                  ...
                  onChange={e =>
                    setUserBackground(prev => ({ ...prev, years_experience: e.target.value }))
                  }
                  placeholder='5'
                  className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
                />
          ...
          <Button onClick={handleGeneration} disabled={isLoading} className='w-full' size='lg'>
            {isLoading ? (
              <>
              ...
              <Card className='p-6'>
                ...
                <div className='space-y-6'>
                  ...
                  <div>
                    ...
                    <div className='space-y-2'>
                      {results.personalization.company_specific_connections.map(
                        (connection, index) => (
                          <div key={index} className='flex items-start p-3 bg-green-50 rounded-lg'>
