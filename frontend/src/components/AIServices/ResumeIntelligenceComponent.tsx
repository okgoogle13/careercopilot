  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='text-center'>
        <h2 className='text-3xl font-bold text-gray-900 mb-2'>Resume Intelligence Analysis</h2>
            ...
            {settings.target_roles.map((role, index) => (
              <div key={index} className='flex gap-2 mb-2'>
                ...
                {settings.target_roles.length > 1 && (
                  <Button variant='outline' size='sm' onClick={() => removeTargetRole(index)}>
                    Remove
                  </Button>
                )}
              </div>
                    ...
                    <div key={index} className='border rounded-lg p-4'>
                      <div className='flex items-center justify-between mb-2'>
                        ...
                        <div className='flex items-center space-x-2'>
                          ...
                          <span
                            className={`text-sm font-medium ${getMarketDemandColor(skill.market_demand)}`}
                          >
                ...
                <div className='space-y-4'>
                  {results.skills_analysis.soft_skills.map((skill, index) => (
                    <div key={index} className='border rounded-lg p-4'>
                      <div className='flex items-center justify-between mb-2'>
                        <h4 className='font-medium text-gray-900'>{skill.skill}</h4>
                        <Badge variant='secondary'>{skill.evidence_strength} Evidence</Badge>
                      </div>
                      {skill.improvement_suggestions.length > 0 && (
                        <div className='mt-2'>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    {results.experience_insights.quantification_opportunities.map(
                      (opportunity, index) => (
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    {results.market_positioning.positioning_recommendations.map(
