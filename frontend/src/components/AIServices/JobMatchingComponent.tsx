    ...
    try {
      const request: JobMatchingRequest = {
        ...
        preferences: {
          ...
          salary_range: preferences.salary_min && preferences.salary_max ? {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setPreferences(prev => ({ ...prev, remote_preference: e.target.value }))}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            >
              <option value="">Any</option>
              ...
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="text-right">
                    <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium text-white ${getMatchScoreColor(job.match_score)}`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h5 className="font-medium text-sm text-gray-700 mb-2">Required Skills You Have:</h5>
                    ...
                    {job.missing_skills.length > 0 && (
                      <div>
                        <h5 className="font-medium text-sm text-gray-700 mb-2">Skills to Develop:</h5>
                        <div className="flex flex-wrap gap-1">
