...
describe('WelcomeBanner', () => {
  ...
  beforeEach(() => {
    ...
    jest.useFakeTimers();
    jest.setSystemTime(new Date('2024-01-20 14:00:00')); // 2 PM = afternoon
  });
  ...
  describe('Greeting Messages', () => {
    it('displays good morning before noon', () => {
      jest.setSystemTime(new Date('2024-01-20 10:00:00')); // 10 AM
      render(<WelcomeBanner userName="John" />);
      expect(screen.getByText(/Good morning/i)).toBeInTheDocument();
    });

    it('displays good afternoon between noon and 5pm', () => {
      jest.setSystemTime(new Date('2024-01-20 14:00:00')); // 2 PM
      render(<WelcomeBanner userName="John" />);
      expect(screen.getByText(/Good afternoon/i)).toBeInTheDocument();
    });

    it('displays good evening after 5pm', () => {
      jest.setSystemTime(new Date('2024-01-20 18:00:00')); // 6 PM
      render(<WelcomeBanner userName="John" />);
