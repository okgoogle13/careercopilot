...
import fiddleLeafFig from '../assets/images/plant-banner.png';
  ...
  return (
    <div className="p-12 max-w-7xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-[var(--on-surface-variant)] tier-body">Curated opportunities that match your profile</p>
      </div>
      ...
      >
        <span className="ml-4 text-[var(--on-surface-variant)] text-sm uppercase tracking-wider tier-data">Quick Filters:</span>
        <div className="flex flex-wrap gap-3">
          {['Remote Only', 'Full-time', 'Tech Industry', 'Senior Level', '$100k+', 'Equity'].map((filter) => (
            <button
              key={filter}
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: noiseOverlay,
          boxShadow: 'inset 0 1px 0 0 rgba(255, 255, 255, 0.1), inset 0 -1px 0 0 rgba(0, 0, 0, 0.2), 0 0 40px rgba(0,0,0,0.2)'
        }}
      >
        ...
        <button
          className="px-8 py-3 rounded-full hover:bg-[#ff8f75] transition-all flex items-center gap-2 text-sm relative z-10 bg-[var(--action-terracotta)] text-[#121212] tier-body-strong shadow-lg shadow-[#E2725B]/20"
        >
