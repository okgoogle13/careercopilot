        ...
        {jobDescription && (
          <div className='ats-notice mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg'>
            <p className='text-sm text-blue-800'>
              <span className='font-medium'>ATS Analysis Active:</span> Templates are scored based
              on your job description for better compatibility.
            </p>
          </div>
        )}
      </div>
              ...
              <div className='template-info'>
                ...
                <div className='template-features'>
                  ...
                  {template.features.length > 3 && (
                    <span className='feature-tag more'>+{template.features.length - 3} more</span>
                  )}
                </div>
              </div>
