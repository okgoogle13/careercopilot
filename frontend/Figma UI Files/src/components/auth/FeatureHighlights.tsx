...
const features = [
  ...
  },
  {
    ...
    description: "Practice with AI-generated questions tailored to your industry and specific job roles.",
    badge: "🧠 Adaptive",
  ...
  },
  {
    ...
    description: "Ensure your resume passes through Applicant Tracking Systems with our advanced analysis.",
    badge: "🛡️ Secure",
  ...
  },
  {
    ...
    description: "Choose from expertly designed templates that highlight your unique strengths and experience.",
    badge: "✨ Design",
  ...
  },
  {
    ...
    description: "Track your application progress and receive insights to improve your job search strategy.",
    badge: "📈 Growth",
    ...
    <div className={className}>
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Transform your job search with AI-powered tools designed to help you land your dream role faster.
        </p>
      </div>
