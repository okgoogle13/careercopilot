...
const NewComponentsShowcase = lazy(() =>
  import('./components/NewComponentsShowcase').then((m) => ({ default: m.NewComponentsShowcase }))
);
...
export default function App() {
  ...
  const demoViews = [
    {
      id: 'main-app',
      label: 'New Tab Navigation',
      icon: Layout,
      description: 'Tab-based app shell (NEW)',
    },
