...
description: "Programmatic validation for Gemini/DALL-E-generated [DEPRECATED_STYLE]\
  \ assets. Automated compliance scoring across 6 dimensions with correction prompts.\
  \ Replaces manual validation loops\u201430-second assessment with binary decision\
  \ (PACKAGE vs. REGENERATE)."
metadata:
  legacy_frontmatter:
    version: 1.0.0
    tags:
