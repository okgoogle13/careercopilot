# Northcote Asset Cataloger Skill

Manifest-driven visual analysis for Northcote Curio design system.
...
- Analyzes images against `northcote-curio-manifest.json` schema
- Validates PNG format, naming conventions, size constraints
- Enforces Gallery/Laboratory mode compliance
...
│   └── mode-compliance.md       # Gallery vs Laboratory rules
...
- Manifest file at: `/Users/okgoogle13/Desktop/careercopilot/assets/northcote-curio-manifest.json`
