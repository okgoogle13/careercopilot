...
const iconSizeMap = {
  16: '20px', 18: '20px', 20: '20px', // Small
  22: '24px', 24: '24px', 28: '24px', // Medium
  32: '40px', 36: '40px', 40: '40px', 48: '40px' // Large
};
...
const Button = styled.button`
  ...
  &:hover { background-color: var(--sys-color-primary-30); }
...
>
  <Box sx={{ animation: 'slideIn 0.3s cubic-bezier(0.4, 0, 0.2, 1)' }}>
    Content
  </Box>
</Modal>
```
...
```json
{
  ...
  "warnings": [
    { "line": 45, "message": "Icon button missing aria-label (accessibility)" }
  ]
}
```
