...
2. **Generate context.md** - Extract specimens from IDF, build narrative
...
- `consult_pro` - Validate specimen endemic status
- `quick_summarize` - Generate narrative from specimen list
