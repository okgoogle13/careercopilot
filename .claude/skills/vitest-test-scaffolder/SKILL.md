...
description: "Scaffolds Vitest unit tests for React components and hooks. Use when creating tests for frontend components."
---
# Vitest Test Scaffolder Workflow

This skill creates comprehensive unit tests for React components using Vitest, React Testing Library, and user-event.
...
3. **Generate test file:**
   - Read template: `.claude/skills/vitest-test-scaffolder/templates/component.test.tsx.tpl`
...
1. **Use template:** `.claude/skills/vitest-test-scaffolder/templates/hook.test.tsx.tpl`
2. **Use `@testing-library/react-hooks` renderHook:**
   ```typescript
...
Claude (using vitest-test-scaffolder):
...
This skill uses **Vitest** (not Jest):
